...
const _sfc_main = /*@__PURE__*/ _defineComponent({
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
        ...
        const __returned__ = { props, emit, __jazorVueSfcBinding0, __jazorVueSfcBinding1, __jazorVueSfcBinding2, __jazorVueSfcBinding3, __jazorVueSfcBinding4, __jazorVueSfcBinding5, __jazorVueSfcBinding6, __jazorVueSfcBinding7, __jazorVueSfcBinding8, __jazorVueSfcBinding9, TodoSummaryCardComponent, get VAlert() { return VAlert; }, get VApp() { return VApp; }, get VBtn() { return VBtn; }, get VCard() { return VCard; }, get VCardText() { return VCardText; }, get VCardTitle() { return VCardTitle; }, get VCheckbox() { return VCheckbox; }, get VChip() { return VChip; }, get VCol() { return VCol; }, get VContainer() { return VContainer; }, get VList() { return VList; }, get VListItem() { return VListItem; }, get VMain() { return VMain; }, get VRow() { return VRow; }, get VSwitch() { return VSwitch; }, get VTextField() { return VTextField; } };
...
export function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (_openBlock(), _createBlock($setup["VApp"], null, {
    default: _withCtx(() => [
      _createVNode($setup["VMain"], null, {
        default: _withCtx(() => [
          _createVNode($setup["VContainer"], { fluid: true }, {
            default: _withCtx(() => [
                        ...
                        default: _withCtx(() => [
                          _createVNode($setup["VCardTitle"], null, {
                            default: _withCtx(() => [...(_cache[5] || (_cache[5] = [
                              _createTextVNode(" RazorVue Todo Workspace ", -1 /* CACHED */)
                            ]))]),
                            _: 1 /* STABLE */
                          }),
                        ...
                        default: _withCtx(() => [
                          _createVNode($setup["VCardTitle"], null, {
                            default: _withCtx(() => [...(_cache[6] || (_cache[6] = [
                              _createTextVNode(" Tasks ", -1 /* CACHED */)
                            ]))]),
                            _: 1 /* STABLE */
                          }),
                          _createVNode($setup["VCardText"], null, {
                            default: _withCtx(() => [
                              ($setup.__jazorVueSfcBinding5)
                                ? (_openBlock(), _createBlock($setup["VAlert"], {
                                  ...
                                  }, null, 8 /* PROPS */, ["type", "variant"]))
                                : (_openBlock(), _createBlock($setup["VList"], {
                                    key: 1,
                                    density: $setup.__jazorVueSfcBinding8
                                  }, {
                                    default: _withCtx(() => [
                                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList($setup.__jazorVueSfcBinding9, (item) => {
