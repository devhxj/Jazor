import { DateTimeModule } from "System/DateTimeModule.js";
import { JDateTime, JGregorianCalendar, RuntimeModule } from "System/RuntimeModule.js";
...
function validateCalendarType(type) {
  ...
  if (value !== localizedCalendarType && value !== usEnglishCalendarType && value !== middleEastFrenchCalendarType && value !== arabicCalendarType && value !== transliteratedEnglishCalendarType && value !== transliteratedFrenchCalendarType)
...
export function _13ca7ecb3e3aade5(instance) {
  return DateTimeModule._fad0c74e1c9df5bb();
}
export function _7ba83b2ccdd567b5(instance) {
  return DateTimeModule._eb38dc04224730ea();
}
export function _2c293866a460d9ea(instance) {
  return 1;
}
export function _23b9e8d671b5210e() {
  return new JGregorianCalendar(localizedCalendarType, defaultTwoDigitYearMax);
}
export function _c043a86ee7a70c81(type) {
  validateCalendarType(type);
  return new JGregorianCalendar(getCalendarTypeValue(type), defaultTwoDigitYearMax);
}
...
export function _1c4bd410ce12db05(instance, time, months) {
  return DateTimeModule._aae197b95f9024a4(time, months);
}
export function _705c207141cada42(instance, time, years) {
  return DateTimeModule._3353d31b02f2bed8(time, years);
}
...
export function _29ccd13d5e5508f8(instance, year, month, day, hour, minute, second, millisecond, era) {
  validateEra(era);
  return new JDateTime(RuntimeModule.createLocalDateTime(year, month, day, hour, minute, second, millisecond), 0);
}
...
export const GregorianCalendarModule = {
  get_CurrentEra,
  get_DefaultTwoDigitYearMax,
  get_LocalizedCalendarType,
  get_USEnglishCalendarType,
  get_MiddleEastFrenchCalendarType,
  get_ArabicCalendarType,
  get_TransliteratedEnglishCalendarType,
  get_TransliteratedFrenchCalendarType,
  ensureWholeNumber,
  getCalendarTypeValue,
