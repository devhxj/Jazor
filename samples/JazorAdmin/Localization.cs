...
public static class Localization
{
    ...
    private static string GetEnglish(TextKey key)
        => key switch
        {
            ...
            TextKey.Audit => "Audit log",
            TextKey.AuditSubtitle => "Review management operations and OpenID protocol events",
            TextKey.IdentityAccessZone => "Identity & access",
            TextKey.PlatformOperationsZone => "Platform operations",
            TextKey.Theme => "Theme",
    ...
    private static string GetChinese(TextKey key)
        => key switch
        {
            ...
            TextKey.Audit => "审计日志",
            TextKey.AuditSubtitle => "查看管理操作与 OpenID 协议事件",
            TextKey.IdentityAccessZone => "身份与访问",
            TextKey.PlatformOperationsZone => "平台运营",
            TextKey.Theme => "主题",
            TextKey.Language => "语言",
