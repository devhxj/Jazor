...
**双向桥接约束**:
- `.jazor/.cs -> Jolt bridge -> .vue/.ts/.js/.css/.html`
- `.vue/.ts/.js/.css/.html -> Jolt bridge -> .jazor/.cs`
...
namespace Jolt.Lsp.Coordinators;
