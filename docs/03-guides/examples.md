...
| `samples/Wiki/` | 端到端示例应用 | 使用与验证参考，并非独立产品线 |
...
部分示例拥有专用的构建、浏览器或 smoke 脚本。可从 [scripts/csharp README](../../scripts/csharp/README.md) 查找当前验证入口；示例产生的 `bin/`、`obj/`、`node_modules/`、`.tmp/` 或测试结果并非文档或源代码，阅读时应加以区分。
