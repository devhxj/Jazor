...
```xml
<ItemGroup>
  <PackageReference Include="ECMAScript.Style" Version="0.18.0" />
  <PackageReference Include="ECMAScript.Vue.Devtools" Version="0.18.0" />
  <PackageReference Include="ECMAScript.VueDataUi" Version="0.18.0" />
  <PackageReference Include="ECMAScript.VuIcons" Version="0.18.0" />
  <PackageReference Include="ECMAScript.Pinia" Version="0.18.0" />
  <PackageReference Include="ECMAScript.VueRoute" Version="0.18.0" />
  <PackageReference Include="ECMAScript.Vuetify" Version="0.18.0" />
  <PackageReference Include="ECMAScript.ElementPlus" Version="0.18.0" />
  <PackageReference Include="ECMAScript.TDesign" Version="0.18.0" />
</ItemGroup>
```
