...
[TestClass]
public sealed class JoltDevServerTests
{
    ...
    public async Task DevHttpServer_ServesTransformedHtmlAndCompiledModule()
    {
        ...
        try
        {
            ...
            var compiler = new OnDemandCompiler(
                new global::ECMAScript.Contract.RazorVue.JazorVueParser(),
                new global::ECMAScript.Contract.RazorVue.JazorVueCompiler(),
                frontendCompiler,
    ...
    public async Task OnDemandCompiler_CompileAsync_SfcStyle_UsesResolvedUrlAsStyleTargetId()
    {
        ...
        try
        {
            ...
            StringAssert.Contains(result.Content, "style.setAttribute(\"data-jolt\", __jazorStyleId);");
    ...
    public async Task OnDemandCompiler_CompileAsync_JazorFile_WhenSourceMapAvailable_ChainsToOriginalSource()
    {
        ...
        try
        {
            ...
            var parser = new global::ECMAScript.Contract.RazorVue.JazorVueParser();
            var vueCompiler = new global::ECMAScript.Contract.RazorVue.JazorVueCompiler();
    ...
    {
        var path = Path.Combine(Path.GetTempPath(), "JoltDevServerTests", Guid.NewGuid().ToString("N"));
