...
[TestClass]
public sealed class JazorVueHostVolarLaneDocumentSymbolProjectionTests
{
    [TestMethod]
    public async Task JazorVueHost_VolarLaneService_GetDocumentSymbols_UsesPrimaryGVueProjectionWhenAvailable()
    {
    ...
    [TestMethod]
    public async Task JazorVueHost_VolarLaneService_GetDocumentSymbols_FallsBackToSourceWhenPrimaryGVueProjectionMissing()
    {
        var document = CreateJazorDocument("<UserCard />");
