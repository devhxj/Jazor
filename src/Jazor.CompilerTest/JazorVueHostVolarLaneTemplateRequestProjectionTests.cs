...
[TestClass]
public sealed class JazorVueHostVolarLaneTemplateRequestProjectionTests
{
    [TestMethod]
    public async Task JazorVueHost_VolarLaneService_UsesPrimaryGVueProjection_ForReferencesAndRename()
    {
    ...
    [TestMethod]
    public async Task JazorVueHost_VolarLaneService_FallsBackToSource_ForReferencesAndRename_WhenPrimaryGVueProjectionMissing()
    {
        var document = CreateJazorDocument("<UserCard />");
        var sourceUri = LspProtocolHelpers.ToDocumentUri(document.DocumentPath);
