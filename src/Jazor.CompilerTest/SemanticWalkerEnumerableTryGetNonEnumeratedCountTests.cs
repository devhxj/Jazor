...
[TestClass]
public sealed class SemanticWalkerEnumerableTryGetNonEnumeratedCountTests
{
    [TestMethod]
    public void Visit_EnumerableTryGetNonEnumeratedCount_UsesBoundImportAndRefOutPacking()
    {
        var block = GetBlockOperation(
            """
            using System.Linq;

            public static class EnumerableTryGetCountScenarios
            {
                public static int GetKnownCount(int[] releaseIds)
                {
                    if (Enumerable.TryGetNonEnumeratedCount(releaseIds, out var count))
                        return count;
        ...
        CollectionAssert.AreEqual(
            new[]
            {
                "static System.Linq.Enumerable.TryGetNonEnumeratedCount<TSource>(System.Collections.Generic.IEnumerable<TSource>, out int)"
            },
            staticKeys,
    ...
    private static IBlockOperation GetBlockOperation(string source)
    {
        ...
        var compilation = CSharpCompilation.Create(
            "EnumerableTryGetCountScenarios",
            [syntaxTree],
        ...
        var method = syntaxTree.GetRoot().DescendantNodes()
            ...
            .Single(static candidate => candidate.Identifier.ValueText == "GetKnownCount");
