...
@"(() => {
  ...
  return v$0;
    ...
    [TestMethod]
    public void VisitObjectCreation_SourceDataCarrierWithOptIn_LowersStructurally()
    {
        var block = GetBlockOperation(@"
            public readonly struct ReadyState
            {
        ...
        AssertScriptEqual(@"{ state: { value: firstRender } }", script);
    }

    [TestMethod]
    public void VisitObjectCreation_SourceDataCarrierObjectInitializerWithOptIn_LowersStructurally()
    {
        var block = GetBlockOperation(@"
            public readonly struct ReadyState
            {
            ...
            class TestClass
            {
                void TestMethod(bool firstRender)
                {
                    var payload = new ReadyEnvelope { State = new ReadyState(firstRender) };
                }
            }
            ");
