// <auto-generated/>
// Source: webidl.inventory.json schema 3, @webref/css@8.7.4
#nullable enable
...
public partial record CssDeclarations
{
    ...
    /// <summary>
    /// Gets or initializes the typed value for the CSS <c>max-size</c> property; null leaves the declaration unset.
    /// 获取或初始化 CSS <c>max-size</c> 属性的强类型值；null 表示不输出该声明。
    /// </summary>
    [global::System.ComponentModel.Description("@#max-size")]
    public CssValue? max_size { get; init; }
    ...
    /// <summary>
    /// Gets or initializes the typed value for the CSS <c>min-size</c> property; null leaves the declaration unset.
    /// 获取或初始化 CSS <c>min-size</c> 属性的强类型值；null 表示不输出该声明。
    /// </summary>
    [global::System.ComponentModel.Description("@#min-size")]
    public CssValue? min_size { get; init; }
    ...
    /// <summary>
    /// Gets or initializes the typed value for the CSS <c>scroll-axis-lock</c> property; null leaves the declaration unset.
    /// 获取或初始化 CSS <c>scroll-axis-lock</c> 属性的强类型值；null 表示不输出该声明。
    /// </summary>
    [global::System.ComponentModel.Description("@#scroll-axis-lock")]
    public CssKeywordValue? scroll_axis_lock { get; init; }
    ...
    /// <summary>
    /// Gets or initializes the typed value for the CSS <c>size</c> property; null leaves the declaration unset.
    /// 获取或初始化 CSS <c>size</c> 属性的强类型值；null 表示不输出该声明。
    /// </summary>
    [global::System.ComponentModel.Description("@#size")]
    public CssValue? size { get; init; }
    ...
    public CssLengthPercentageValue? text_decoration_inset { get; init; }
