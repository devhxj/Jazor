...
public sealed class ESGeneratorTests
{
    ...
    [TestMethod]
    public void GenerateCatalog_WithComponentBaseOnInitializedAsyncPassThroughAndTrailingNoOp_KeepsTemplateOnlyBoundaryWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.ComponentBaseOnInitializedAsyncPassThroughTrailingNoOp.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithDefaultTaskOnInitializedAsyncLifecycle_ReportsJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.DefaultTaskOnInitializedAsync.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithSourceStableLocalOnlyAsyncNoOpAwaitLifecycle_DoesNotEmitLifecycleHooks()
    {
        var compilation = CreateCompilation(
            "RazorVue.SourceStableLocalOnlyAsyncNoOpAwaitLifecycle.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/async-noop-await-card")]
                public class AsyncNoOpAwaitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        Assert.AreEqual(0, lifecycleDiagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "components/async-noop-await-card.mjs");
        Assert.IsFalse(generatedSource.Contains("Task.CompletedTask", StringComparison.Ordinal), generatedSource);
        Assert.IsFalse(generatedSource.Contains("onMounted", StringComparison.Ordinal), generatedSource);
        Assert.IsFalse(generatedSource.Contains("watch", StringComparison.Ordinal), generatedSource);
        Assert.IsFalse(generatedSource.Contains("onUpdated", StringComparison.Ordinal), generatedSource);
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.TemplateOnly");
    ...
    [TestMethod]
    public void GenerateCatalog_WithTerminalNoOpReturnLifecycle_DoesNotEmitLifecycleHooks()
    {
        var compilation = CreateCompilation(
            "RazorVue.TerminalNoOpReturnLifecycle.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/terminal-noop-card")]
                public class TerminalNoOpCard : ComponentBase, IVueComponent
                {
                    [Parameter]
    ...
    [TestMethod]
    public void GenerateCatalog_WithNoContractStaticTemplate_KeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.NoContractStaticTemplate.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.TemplateOnly");
        StringAssert.Contains(generatedSource, "return () => h(\\\"span\\\", null, \\\"static\\\");");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalLambdaShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.LocalLambdaShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
    ...
    [TestMethod]
    public void GenerateCatalog_WithMethodGroupDelegateLocalShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.MethodGroupDelegateLocalShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "function IsReady(value)");
        StringAssert.Contains(generatedSource, " = IsReady;");
        StringAssert.Contains(generatedSource, "return __jazorShouldRenderLocal");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }
    ...
    {
        var compilation = CreateCompilation(
            "RazorVue.SwitchExpressionShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-switch-expression")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
        StringAssert.Contains(generatedSource, "const __swexpr$");
        StringAssert.Contains(generatedSource, "props.value");
    }

    [TestMethod]
    public void GenerateCatalog_WithLocalPrefixedShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.LocalPrefixedShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-local")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalMutationShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.LocalMutationShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
    ...
    [TestMethod]
    public void GenerateCatalog_WithIfElseShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.IfElseShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-if")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSwitchShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.SwitchShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
    ...
    [TestMethod]
    public void GenerateCatalog_WithTryCatchFinallyShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.TryCatchFinallyShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        StringAssert.Contains(generatedSource, "finally {");
    }

    [TestMethod]
    public void GenerateCatalog_WithThrowBranchShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.ThrowBranchShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
        StringAssert.Contains(generatedSource, "throw new Error(\\\"negative\\\");");
    }

    [TestMethod]
    public void GenerateCatalog_WithNestedGuardedSwitchShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.NestedGuardedSwitchShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-nested-switch")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
        StringAssert.Contains(generatedSource, "const __jazorShouldRenderSwitchFallthrough = {};");
        StringAssert.Contains(generatedSource, "const __jazorShouldRenderSwitchResult = (() => {");
        StringAssert.Contains(generatedSource, "if (__jazorShouldRenderSwitchResult !== __jazorShouldRenderSwitchFallthrough)");
        StringAssert.Contains(generatedSource, "const __swpat$");
    }

    [TestMethod]
    public void GenerateCatalog_WithReservedCatchLocalShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.ReservedCatchLocalShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
        StringAssert.Contains(generatedSource, "} catch (__jazorShouldRenderLocal");
        Assert.IsFalse(generatedSource.Contains("catch (props)", StringComparison.Ordinal), generatedSource);
    }

    [TestMethod]
    public void GenerateCatalog_WithPatternLocalShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.PatternLocalShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-pattern")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
    ...
    [TestMethod]
    public void GenerateCatalog_WithRecursivePatternDeclaredLocalShouldRender_DoesNotReportJAZORVGA005_AndKeepsLogicSafeBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.RecursivePatternDeclaredLocalShouldRender.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/should-render-recursive-pattern")]
                public class ShouldRenderCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public object? Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithPassThroughShouldRenderToSupportedBase_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.InheritedShouldRenderPassThrough.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
            ...
            namespace Demo.Components
            {
                public abstract class ShouldRenderBaseCard : ComponentBase, IVueComponent
                {
                    protected override bool ShouldRender()
                    {
                        return true;
                ...
                [ECMAScript.ECMAScriptModule("./components/should-render-inherited")]
    ...
    [TestMethod]
    public void GenerateCatalog_WithExpressionBodiedNoOpSetParametersAsync_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.ExpressionBodiedNoOpSetParametersAsync.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithSetParametersAsyncBaseThenReturnAndUnreachableEmit_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncReturnUnreachableEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        Assert.IsFalse(generatedSource.Contains("watch(", StringComparison.Ordinal), generatedSource);
        Assert.IsFalse(generatedSource.Contains("await emit(\\\"update:value\\\"", StringComparison.Ordinal), generatedSource);
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.TemplateOnly");
    }

    [TestMethod]
    public void GenerateCatalog_WithSetParametersAsyncBaseThenTerminalGuardReturn_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncTerminalGuardReturn.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-terminal-guard-return")]
                public class SetParametersAsyncTerminalGuardReturnCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSetParametersAsyncBaseThenDoubleReturnIfElse_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncDoubleReturnIfElse.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-double-return-if-else")]
                public class SetParametersAsyncDoubleReturnIfElseCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenConditionalEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncConditionalEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-conditional-emit")]
                public class SetParametersAsyncConditionalEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, "if ((props.value > 0)) {");
        StringAssert.Contains(generatedSource, "await emit(\\\"update:value\\\", props.value);");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", true);");
        StringAssert.Contains(generatedSource, "} else {");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", false);");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }

    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenLocalConditionEmit_MaterializesLocalOnce()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncLocalConditionEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-local-condition-emit")]
                public class SetParametersAsyncLocalConditionEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        Assert.AreEqual(0, lifecycleDiagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        var localDeclarationIndex = generatedSource.IndexOf("const __jazorLifecycleLocal", StringComparison.Ordinal);
        var secondLocalDeclarationIndex = localDeclarationIndex < 0
            ? -1
            : generatedSource.IndexOf("const __jazorLifecycleLocal", localDeclarationIndex + 1, StringComparison.Ordinal);

        Assert.IsTrue(localDeclarationIndex >= 0, generatedSource);
        Assert.AreEqual(-1, secondLocalDeclarationIndex, generatedSource);
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, " = (props.value > 0);");
        StringAssert.Contains(generatedSource, "if (__jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "await emit(\\\"update:value\\\", props.value);");
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenSwitchEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncSwitchEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-switch-emit")]
                public class SetParametersAsyncSwitchEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, "switch (props.value) {");
        StringAssert.Contains(generatedSource, "case 0:");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", false);");
        StringAssert.Contains(generatedSource, "case 1:");
        StringAssert.Contains(generatedSource, "case 2:");
        StringAssert.Contains(generatedSource, "await emit(\\\"update:value\\\", props.value);");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", true);");
        StringAssert.Contains(generatedSource, "default:");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", (props.value > 0));");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }

    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryFinallyEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryFinallyEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-finally-emit")]
                public class SetParametersAsyncTryFinallyEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryFinallyEmptyTryCleanup_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryFinallyEmptyTryCleanup.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-finally-empty-try-cleanup")]
                public class SetParametersAsyncTryFinallyEmptyTryCleanupCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryFinallyCompletedTaskTryCleanup_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryFinallyCompletedTaskTryCleanup.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-finally-completed-task-try-cleanup")]
                public class SetParametersAsyncTryFinallyCompletedTaskTryCleanupCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-emit")]
                public class SetParametersAsyncTryCatchEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchEmptyTryRecovery_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchEmptyTryRecovery.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-empty-try-recovery")]
                public class SetParametersAsyncTryCatchEmptyTryRecoveryCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchEmptyCatch_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchEmptyCatch.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-empty-catch")]
                public class SetParametersAsyncTryCatchEmptyCatchCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchCompletedTaskCatch_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchCompletedTaskCatch.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-completed-task-catch")]
                public class SetParametersAsyncTryCatchCompletedTaskCatchCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenCatchAllEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncCatchAllEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-catch-all-emit")]
                public class SetParametersAsyncCatchAllEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenUnusedCatchVariableEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncUnusedCatchVariableEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-unused-catch-variable-emit")]
                public class SetParametersAsyncUnusedCatchVariableEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        StringAssert.Contains(generatedSource, "await emit(\\\"update:value\\\", props.value);");
        StringAssert.Contains(generatedSource, "} catch {");
        Assert.IsFalse(generatedSource.Contains("catch (", StringComparison.Ordinal), generatedSource);
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", false);");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }

    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenCatchFilterEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncCatchFilterEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-catch-filter-emit")]
                public class SetParametersAsyncCatchFilterEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, "catch (__jazorLifecycleCatch) {");
        StringAssert.Contains(generatedSource, "let __jazorLifecycleCatchHandled = false;");
        StringAssert.Contains(generatedSource, "__jazorLifecycleCatchHandled = __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "} catch {");
        StringAssert.Contains(generatedSource, "if (__jazorLifecycleCatchHandled) {");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", false);");
        StringAssert.Contains(generatedSource, "throw __jazorLifecycleCatch;");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }

    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenCatchVariableNonNullFilterEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncCatchVariableNonNullFilterEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-catch-variable-non-null-filter-emit")]
                public class SetParametersAsyncCatchVariableNonNullFilterEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, "catch (__jazorLifecycleCatch) {");
        StringAssert.Contains(generatedSource, "__jazorLifecycleCatchHandled = true;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", false);");
        StringAssert.Contains(generatedSource, "throw __jazorLifecycleCatch;");
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-emit")]
                public class SetParametersAsyncTryCatchFinallyEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyEmptyFinally_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyEmptyFinally.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-empty-finally")]
                public class SetParametersAsyncTryCatchFinallyEmptyFinallyCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyCompletedTaskFinally_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyCompletedTaskFinally.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-completed-task-finally")]
                public class SetParametersAsyncTryCatchFinallyCompletedTaskFinallyCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyEmptyTryCatchCleanup_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyEmptyTryCatchCleanup.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-empty-try-catch-cleanup")]
                public class SetParametersAsyncTryCatchFinallyEmptyTryCatchCleanupCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyUnusedCatchVariableEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyUnusedCatchVariableEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-unused-catch-variable-emit")]
                public class SetParametersAsyncTryCatchFinallyUnusedCatchVariableEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryFinallyGuardReturnEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryFinallyGuardReturnEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-finally-guard-return-emit")]
                public class SetParametersAsyncTryFinallyGuardReturnEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryFinallyBareReturn_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryFinallyBareReturn.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-finally-bare-return")]
                public class SetParametersAsyncTryFinallyBareReturnCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyGuardReturnEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFinallyGuardReturnEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-finally-guard-return-emit")]
                public class SetParametersAsyncTryCatchFinallyGuardReturnEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        Assert.AreEqual(1, generatedSource.Split("const __jazorLifecycleLocal", StringSplitOptions.None).Length - 1, generatedSource);
        StringAssert.Contains(generatedSource, "try {");
        StringAssert.Contains(generatedSource, "if (!__jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "return;");
        StringAssert.Contains(generatedSource, "await emit(\\\"update:value\\\", props.value);");
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFilterFinallyGuardReturnEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncTryCatchFilterFinallyGuardReturnEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-filter-finally-guard-return-emit")]
                public class SetParametersAsyncTryCatchFilterFinallyGuardReturnEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenGuardReturnEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncGuardReturnEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-guard-return-emit")]
                public class SetParametersAsyncGuardReturnEmitCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenIfReturnElseEmit_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncIfReturnElseEmit.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenIfEmitElseReturn_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SupportedSetParametersAsyncIfEmitElseReturn.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetParametersAsyncBaseThenTryCatchFinallyBareReturn_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncTryCatchFinallyBareReturn.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                ...
                public class SetParametersAsyncTryCatchFinallyBareReturnCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSetParametersAsyncBaseThenTryCatchBareReturnWithFilterWithoutRuntimeBeforeReturn_DoesNotReportJAZORVGA005_AndKeepsTemplateOnlyBoundary()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncTryCatchBareReturnFilterNoOp.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-try-catch-bare-return-filter")]
                public class SetParametersAsyncTryCatchBareReturnCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
    ...
    {
        var compilation = CreateCompilation(
            "RazorVue.SetParametersAsyncEmitThenIfElseReturn.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            ...
            namespace Demo.Components
            {
                [ECMAScript.ECMAScriptModule("./components/set-parameters-async-emit-then-if-else-return")]
                public class SetParametersAsyncEmitThenIfElseReturnCard : ComponentBase, IVueComponent
                {
                    [Parameter]
                    public int Value { get; set; }
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        var localDeclarationIndex = generatedSource.IndexOf("const __jazorLifecycleLocal", StringComparison.Ordinal);
        var secondLocalDeclarationIndex = generatedSource.IndexOf("const __jazorLifecycleLocal", localDeclarationIndex + 1, StringComparison.Ordinal);
        var emitIndex = generatedSource.IndexOf("await emit(\\\"update:value\\\", props.value);", StringComparison.Ordinal);
        var ifIndex = generatedSource.IndexOf("if (!__jazorLifecycleLocal", StringComparison.Ordinal);
        var firstReturnIndex = generatedSource.IndexOf("return;", StringComparison.Ordinal);
        var elseIndex = generatedSource.IndexOf("} else {", StringComparison.Ordinal);
        var secondReturnIndex = generatedSource.IndexOf("return;", firstReturnIndex + 1, StringComparison.Ordinal);

        StringAssert.Contains(generatedSource, "watch(() => [props.value], async () => {");
        Assert.IsTrue(localDeclarationIndex >= 0, generatedSource);
        Assert.AreEqual(-1, secondLocalDeclarationIndex, generatedSource);
        Assert.IsTrue(emitIndex > localDeclarationIndex, generatedSource);
        Assert.IsTrue(ifIndex > emitIndex, generatedSource);
        Assert.IsTrue(firstReturnIndex > ifIndex, generatedSource);
        Assert.IsTrue(elseIndex > firstReturnIndex, generatedSource);
        Assert.IsTrue(secondReturnIndex > elseIndex, generatedSource);
        StringAssert.Contains(generatedSource, "hmrBoundaryKind: GeneratedHmrBoundaryKind.LogicSafe");
    }

    [TestMethod]
    public void GenerateCatalog_WithSetParametersAsyncPassThroughToExternalOverrideWithoutSource_DoesNotReportJAZORVGA005_AndKeepsFullReloadBoundary()
    {
        var upstreamCompilation = CreateCompilation(
            "External.SetParametersAsync.Base",
            """
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        using var upstreamImage = new MemoryStream();
        var upstreamEmit = upstreamCompilation.Emit(upstreamImage);
        Assert.IsTrue(
            upstreamEmit.Success,
            string.Join("\n", upstreamEmit.Diagnostics.Select(static x => x.ToString())));

        var compilation = CreateCompilation(
            "RazorVue.ExternalUnsupportedSetParametersAsync.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithDeclarationInitializedPropertyLifecyclePayload_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.DeclarationInitializedPropertyLifecyclePayload.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "const prefix = \\\"Count: \\\";");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], () => {");
        StringAssert.Contains(generatedSource, "emit(\\\"update:value\\\", prefix);");
        Assert.IsTrue(
            generatedSource.IndexOf("const prefix = \\\"Count: \\\";", StringComparison.Ordinal) <
            generatedSource.IndexOf("watch(() => [props.value], () => {", StringComparison.Ordinal),
            generatedSource);
    }

    [TestMethod]
    public void GenerateCatalog_WithSourceStableValueMemberLocalOnlyLifecycleBody_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.SourceStableValueMemberLocalOnlyLifecycleBody.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        Assert.IsFalse(generatedSource.Contains("onMounted", StringComparison.Ordinal), generatedSource);
        Assert.IsFalse(generatedSource.Contains("Count: ", StringComparison.Ordinal), generatedSource);
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithCallableLocalLifecyclePayload_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.CallableLocalLifecyclePayload.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
    ...
    [TestMethod]
    public void GenerateCatalog_WithHelperCallOptionalParamsAndNamedPayloadsOnParametersSetLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.HelperCallOptionalParamsAndNamedOnParametersSetLifecyclePayload.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "function formatLabel(value, prefix)");
        StringAssert.Contains(generatedSource, "function countValues(values)");
        StringAssert.Contains(generatedSource, "function formatNamed(value, prefix, suffix)");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], () => {");
        StringAssert.Contains(generatedSource, "emit(\\\"labelChanged\\\", formatLabel(props.value, \\\"Count: \\\"));");
        StringAssert.Contains(generatedSource, "emit(\\\"countChanged\\\", countValues([props.value, 42]));");
        StringAssert.Contains(generatedSource, "emit(\\\"labelChanged\\\", ((suffix) => ((value) => ((prefix) => formatNamed(value, prefix, suffix))(\\\"Count: \\\"))(props.value))(\\\"!\\\"));");
    }
    ...
    {
        var compilation = CreateCompilation(
            "RazorVue.DeclarationInitializedFieldLifecyclePayload.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "const _readyCode = 7;");
    ...
    {
        var compilation = CreateCompilation(
            "RazorVue.HelperCallLifecyclePayload.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", runResult.Results.SelectMany(static result => result.Diagnostics).Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "const prefix = \\\"Count: \\\";");
        StringAssert.Contains(generatedSource, "function formatLabel()");
        StringAssert.Contains(generatedSource, "return (prefix + props.value);");
        StringAssert.Contains(generatedSource, "watch(() => [props.value], () => {");
        StringAssert.Contains(generatedSource, "emit(\\\"update:value\\\", formatLabel());");
        Assert.IsTrue(
    ...
    [TestMethod]
    public void GenerateCatalog_WithAsyncHelperCallLifecyclePayload_ReportsJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.AsyncHelperCallLifecyclePayload.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
    ...
    [TestMethod]
    public void GenerateCatalog_WithCastFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithChainedFirstRenderExpressionPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", ((currentFirstRender ? \\\"True\\\" : \\\"False\\\").length > 0));");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithCoalescedFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", currentFirstRender ?? false);");
    }

    [TestMethod]
    public void GenerateCatalog_WithHelperCallFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", normalize(currentFirstRender));");
    }

    [TestMethod]
    public void GenerateCatalog_WithEqualsFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithDeepMemberChainFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", { state: { value: currentFirstRender } }.state.value);");
    }

    [TestMethod]
    public void GenerateCatalog_WithInstanceEqualsFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalFunctionFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "function __jazorLifecycleLocalFunction");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", __jazorLifecycleLocalFunction");
        StringAssert.Contains(generatedSource, "(currentFirstRender));");
    }

    [TestMethod]
    public void GenerateCatalog_WithMethodReturnedDeepMemberChainFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "function buildEnvelope(value)");
        StringAssert.Contains(generatedSource, "return ({ state: { value: value } });");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", buildEnvelope(currentFirstRender).state.value);");
    }

    [TestMethod]
    public void GenerateCatalog_WithDeepMemberChainEqualsFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", { state: { value: currentFirstRender } }.state.value === true);");
    }

    [TestMethod]
    public void GenerateCatalog_WithHelperReturnedEqualsFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", buildReady(currentFirstRender).value === true);");
    }

    [TestMethod]
    public void GenerateCatalog_WithPropertyPatternFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", (() => {");
        StringAssert.Contains(generatedSource, "let __patin$");
        StringAssert.Contains(generatedSource, "= { state: { value: currentFirstRender } }");
        StringAssert.Contains(generatedSource, "\\\"state\\\" in __patin$");
        StringAssert.Contains(generatedSource, "\\\"value\\\" in __patin$");
        StringAssert.Contains(generatedSource, ".state.value === true");
    }

    [TestMethod]
    public void GenerateCatalog_WithSwitchExpressionFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", (() => {");
        StringAssert.Contains(generatedSource, "const __swexpr$");
        StringAssert.Contains(generatedSource, "__swexpr$");
        StringAssert.Contains(generatedSource, "=== true");
        StringAssert.Contains(generatedSource, "=== false");
    }

    [TestMethod]
    public void GenerateCatalog_WithDeclarationPatternFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.DeclarationPatternFirstRenderPayloadOnAfterRenderAsyncLifecycle.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", ((() => {");
        StringAssert.Contains(generatedSource, "let ready;");
        StringAssert.Contains(generatedSource, "typeof currentFirstRender === \\\"boolean\\\"");
        StringAssert.Contains(generatedSource, "(ready = currentFirstRender, true)");
        StringAssert.Contains(generatedSource, "&& ready");
    }

    [TestMethod]
    public void GenerateCatalog_WithHelperReturnedPropertyPatternFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", (() => {");
        StringAssert.Contains(generatedSource, "let __patin$");
        StringAssert.Contains(generatedSource, "= buildEnvelope(currentFirstRender)");
        StringAssert.Contains(generatedSource, "\\\"state\\\" in __patin$");
        StringAssert.Contains(generatedSource, "\\\"value\\\" in __patin$");
        StringAssert.Contains(generatedSource, ".state.value === true");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithObjectInitializerMemberAccessFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithTupleMemberAccessFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", { firstRender: currentFirstRender, item2: { value: currentFirstRender } }.item2.value);");
    }

    [TestMethod]
    public void GenerateCatalog_WithIsPatternTrueFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithIsPatternFalseFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithIsPatternNotFalseFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithIsPatternNotTrueFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithIsPatternOrFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", currentFirstRender === true || currentFirstRender === false);");
    }

    [TestMethod]
    public void GenerateCatalog_WithTypePatternFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", typeof currentFirstRender === \\\"boolean\\\");");
    }

    [TestMethod]
    public void GenerateCatalog_WithObjectTypePatternFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", currentFirstRender != null && typeof currentFirstRender === \\\"object\\\");");
    }

    [TestMethod]
    public void GenerateCatalog_WithPatternCombinatorFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalLambdaFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithNullConditionalCoalescedFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, ".state?.value");
        StringAssert.Contains(generatedSource, "?? false");
    }

    [TestMethod]
    public void GenerateCatalog_WithTupleDeconstructionFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalAliasFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithFirstRenderMemberAccessPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", { value: currentFirstRender }.value);");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithArrayIndexerFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
    ...
    [TestMethod]
    public void GenerateCatalog_WithListIndexedMemberChainFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "import { _d389c31d59037b42 } from \\\"System/Collections/Generic/ListT1Module.js\\\";");
        StringAssert.Contains(generatedSource, "[{ state: { value: false } }, { state: { value: currentFirstRender } }]");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", _d389c31d59037b42(__jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, ").state.value);");
    }

    [TestMethod]
    public void GenerateCatalog_WithArrayPatternCapturedFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "Array.isArray(__jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", __jazorLifecycleLocal");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalFirstRenderPayloadOnInitializedLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "onMounted(() => {");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, " = 1;");
        StringAssert.Contains(generatedSource, "emit(\\\"valueChanged\\\", __jazorLifecycleLocal");
        Assert.IsFalse(generatedSource.Contains("const currentFirstRender = firstRender;", StringComparison.Ordinal), generatedSource);
    }

    [TestMethod]
    public void GenerateCatalog_WithLocalFirstRenderPayloadOnInitializedAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, " = 1;");
        StringAssert.Contains(generatedSource, "await emit(\\\"valueChanged\\\", __jazorLifecycleLocal");
        Assert.IsFalse(generatedSource.Contains("const currentFirstRender = firstRender;", StringComparison.Ordinal), generatedSource);
    }

    [TestMethod]
    public void GenerateCatalog_WithLocalFirstRenderPayloadOnParametersSetLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "watch(() => [], () => {");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, " = 1;");
        StringAssert.Contains(generatedSource, "emit(\\\"valueChanged\\\", __jazorLifecycleLocal");
        Assert.IsFalse(generatedSource.Contains("const currentFirstRender = firstRender;", StringComparison.Ordinal), generatedSource);
    ...
    [TestMethod]
    public void GenerateCatalog_WithLocalFirstRenderPayloadOnParametersSetAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "watch(() => [], async () => {");
        StringAssert.Contains(generatedSource, "const __jazorLifecycleLocal");
        StringAssert.Contains(generatedSource, " = 1;");
        StringAssert.Contains(generatedSource, "await emit(\\\"valueChanged\\\", __jazorLifecycleLocal");
        Assert.IsFalse(generatedSource.Contains("const currentFirstRender = firstRender;", StringComparison.Ordinal), generatedSource);
    ...
    [TestMethod]
    public void GenerateCatalog_WithHelperCallOmittedOptionalFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.HelperCallOmittedOptionalFirstRenderOnAfterRenderAsyncLifecyclePayload.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", normalize(currentFirstRender, \\\"ready:\\\"));");
    }

    [TestMethod]
    public void GenerateCatalog_WithHelperCallParamsFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.HelperCallParamsFirstRenderOnAfterRenderAsyncLifecyclePayload.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", normalize([currentFirstRender, false]));");
    }

    [TestMethod]
    public void GenerateCatalog_WithHelperCallNamedArgumentsOutOfDeclarationOrderFirstRenderPayloadOnAfterRenderAsyncLifecycle_LowersWithoutJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.HelperCallNamedArgumentsFirstRenderOnAfterRenderAsyncLifecyclePayload.Generated",
            """
            using System;
            using System.Threading.Tasks;
            using ECMAScript.VueContract;
        ...
        StringAssert.Contains(generatedSource, "const currentFirstRender = firstRender;");
        StringAssert.Contains(generatedSource, "firstRender = false;");
        StringAssert.Contains(generatedSource, "await emit(\\\"readyChanged\\\", ((suffix) => ((value) => ((prefix) => normalize(value, prefix, suffix))(\\\"ready:\\\"))(currentFirstRender))(\\\"!\\\"));");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithSupportedSetupPropertyLowering_GeneratesCatalogSource()
    {
        var compilation = CreateCompilation(
            "RazorVue.SetupProperty.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
        ...
        Assert.AreEqual(0, diagnostics.Length, string.Join("\n", diagnostics.Select(static x => x.ToString())));
        StringAssert.Contains(generatedSource, "function prefix()");
        StringAssert.Contains(generatedSource, "return \\\"Count: \\\";");
    ...
    {
        var compilation = CreateCompilation(
            "RazorVue.ValueSetupProperty.Generated",
            """
            using System;
            using ECMAScript.VueContract;
            using Microsoft.AspNetCore.Components;
    ...
    public void GenerateCatalog_WithThreeLevelHelperComposition_GeneratesCatalogSource()
    {
        ...
        CollectionAssert.Contains(hints, "Jazor.Generated.RazorVueCatalog.g.cs");
        var generatedSource = GetGeneratedSource(runResult, "Jazor.Generated.RazorVueCatalog.g.cs");
        StringAssert.Contains(generatedSource, "function formatOuter(value)");
        StringAssert.Contains(generatedSource, "function formatMiddle(value)");
        StringAssert.Contains(generatedSource, "function formatInner(value)");
        StringAssert.Contains(generatedSource, "return (\\\"Value: \\\" + formatMiddle(value));");
        StringAssert.Contains(generatedSource, "return (\\\"Middle: \\\" + formatInner(value));");
        StringAssert.Contains(generatedSource, "return ((value * 3)).toString();");
        StringAssert.Contains(generatedSource, "formatOuter(props.value)");
    }
    ...
    [TestMethod]
    public void GenerateCatalog_WithParameterizedSourceStableHelperLocalOnlyLifecycleBody_DoesNotReportJAZORVGA005()
    {
        var compilation = CreateCompilation(
            "RazorVue.ParameterizedNoOpLifecycle.Generated",
            """
            using System;
            using ECMAScript.VueContract;
