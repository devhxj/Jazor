...
public sealed class BuildRenderTreeTemplateFrontendTests
{
    ...
    [TestMethod]
    public void CreateRenderTree_WithBuildRenderTreeLocalFunctionHelperRequiringInParameter_ProducesStructuredNodes()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithCurrentComponentRenderHelperMethodRequiringInParameter_ProducesStructuredNodes()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithCurrentComponentRenderHelperMethodRequiringReadOnlyRefParameter_ProducesStructuredNodes()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithCurrentComponentRenderHelperMethodRequiringReadOnlyRefParameterAndCallerOwnedAttributeMutation_PreservesOpenElementAttributes()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.AreEqual(1, attribute.CapturedBindings.Length);
        Assert.AreEqual("title", attribute.CapturedBindings[0].ParameterSymbol.Name);
        Assert.IsInstanceOfType<ILocalReferenceOperation>(attribute.CapturedBindings[0].Initializer);
    }

    [TestMethod]
    public void CreateRenderTree_WithCurrentComponentRenderHelperMethodForwardingInParameterToByRefTarget_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithRenderFragmentGetterReturningSourceStableLocalChain_ProducesTemplateScopeNode()
    {
        var context = CreateContext(
            """
            using System;
        ...
        var scope = renderTree.Children.Single() as RazorVueTemplateScopeNode;
        Assert.IsNotNull(scope);
        Assert.AreEqual("item", scope.ScopeName);
        Assert.IsInstanceOfType<ILiteralOperation>(scope.Initializer);
        Assert.IsInstanceOfType<RazorVueElementNode>(scope.Children.Children.Single());
    }

    [TestMethod]
    public void CreateRenderTree_WithCurrentComponentRenderFragmentFactoryBlockBodyReturningSourceStableLocalChain_ProducesNestedTemplateScopeNodes()
    {
        var context = CreateContext(
            """
            using System;
        ...
        var itemScope = titleScope.Children.Children.Single() as RazorVueTemplateScopeNode;
        Assert.IsNotNull(itemScope);
        Assert.AreEqual("item", itemScope.ScopeName);
        Assert.IsInstanceOfType<ILiteralOperation>(itemScope.Initializer);
    }
    ...
    [TestMethod]
    public void CreateRenderTree_WithLocalRenderFragmentFactoryBlockBodyReturningSourceStableLocalChain_ProducesNestedTemplateScopeNodes()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithRenderFragmentFactoryViaDelegateDataflow_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithRenderFragmentFactoryTemplateBodyReturnedByCallable_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithCyclicLocalRenderFragmentFactoryMethods_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        RenderFragment<int> CreateTemplateA() => CreateTemplateB();
                        RenderFragment<int> CreateTemplateB() => CreateTemplateA();
    ...
    [TestMethod]
    public void CreateRenderTree_WithBranchAssignedRenderFragmentLocalCarrier_PreservesImperativeRootBlock()
    {
        var context = CreateContext(
            """
            using System;
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    ...
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        ...
                        if (UseStrong)
                        {
                            template = item => itemBuilder =>
                            {
                                itemBuilder.OpenElement(1, "strong");
                                itemBuilder.AddContent(2, item);
                                itemBuilder.CloseElement();
                            };
                        }
                        ...
                        builder.AddContent(5, template, 42);
                    }
                }
            }
            """);
        ...
        Assert.AreEqual(1, renderTree.Children.Length);
        Assert.IsInstanceOfType<RazorVueImperativeBlockNode>(renderTree.Children[0]);
    }

    [TestMethod]
    public void CreateRenderTree_WithLocalFunctionMutatedRenderFragmentLocalCarrier_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithConcatenatedStaticAddMarkupContentCarriers_ProducesStaticMarkupNodes()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithScriptAddMarkupContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithLocalFunctionMutatedAddMarkupContentCarrier_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.AreEqual(RazorVueIssueCode.CanonicalizationFailed, exception.Issue.Code);
        StringAssert.Contains(exception.Issue.Message, "string local 'markup'");
        StringAssert.Contains(exception.Issue.Message, "later writes");
    }
    ...
    [TestMethod]
    public void CreateRenderTree_WithHelperMutatedSettableAddMarkupContentPropertyCarrier_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithConcatenatedStaticMarkupStringCarriers_ProducesStaticMarkupNodes()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    ...
                    {
                        string open = "<section class=\"hero\">";
                        MarkupString body = (MarkupString)"<span>safe</span><p>ok</p>";
                        string close = "</section>";
                        builder.AddContent(0, (MarkupString)(open + body + close));
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithDynamicNewMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    ...
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        builder.AddContent(0, new MarkupString("<section>" + Title + "</section>"));
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithDynamicConcatenatedMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    ...
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        string open = "<section>";
                        string close = "</section>";
                        builder.AddContent(0, (MarkupString)(open + Title + close));
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithMutatedConcatenatedAddMarkupContentCarrier_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    private string _open = "<section class=\"hero\">";

                    protected override void OnParametersSet()
                    {
                        _open = "<section class=\"changed\">";
                    }

                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        string body = "<span>safe</span></section>";
                        builder.AddMarkupContent(0, _open + body);
                    }
                }
            }
            """);
        ...
        Assert.AreEqual(RazorVueIssueCode.CanonicalizationFailed, exception.Issue.Code);
        StringAssert.Contains(exception.Issue.Message, "_open");
        StringAssert.Contains(exception.Issue.Message, "later writes");
    }

    [TestMethod]
    public void CreateRenderTree_WithUnsafeConcatenatedAddMarkupContentCarriers_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    ...
                    {
                        string open = "<scr";
                        string close = "ipt>alert('x')</script>";
                        builder.AddMarkupContent(0, open + close);
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithInlineEventMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithDirectiveMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithExecutableUrlMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        builder.AddContent(0, (MarkupString)"<a href=\"java&#x0A;script:alert(1)\">safe</a>");
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithVbscriptUrlMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        builder.AddContent(0, (MarkupString)"<a href=\"vb&#x09;script:msgbox(1)\">safe</a>");
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithExecutableDataUriMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithSrcdocMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithFormActionMarkupStringAddContent_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithMalformedStaticMarkupAttributeName_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        builder.AddContent(0, (MarkupString)"<section x\"onclick=\"alert(1)\">safe</section>");
                    }
                }
            }
            """);
        ...
        StringAssert.Contains(exception.Issue.Message, "x\"onclick");
    }

    [TestMethod]
    public void CreateRenderTree_WithMalformedStaticMarkupElementName_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
            ...
            namespace Demo.Components
            {
                ...
                public class Host : ComponentBase, IVueComponent
                {
                    protected override void BuildRenderTree(RenderTreeBuilder builder)
                    {
                        builder.AddMarkupContent(0, "<section><x<script>safe</x<script></section>");
                    }
                }
            }
            """);
    ...
    [TestMethod]
    public void CreateRenderTree_WithLoopAssignedMarkupStringLocalCarrier_PreservesImperativeRootBlock()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithRefEscapedMarkupStringLocalCarrier_ThrowsCanonicalizationFailed()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.AreEqual(RazorVueIssueCode.CanonicalizationFailed, exception.Issue.Code);
        StringAssert.Contains(exception.Issue.Message, "standalone invocation");
        StringAssert.Contains(exception.Issue.Message, "Replace(ref MarkupString markup)");
    }
    ...
    [TestMethod]
    public void CreateRenderTree_WithLoopVariableDependentForStep_ProducesImperativeLoopBlockNode()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithSideEffectingForStep_ProducesImperativeLoopBlockNode()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithGotoStatement_ProducesImperativeSegmentWithGotoBranch()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.IsTrue(imperative.Operations
            .Select(static operation => RazorVueOperationNormalizer.Unwrap(operation))
            .OfType<ILabeledOperation>()
            .Any());
    }

    [TestMethod]
    public void CreateRenderTree_WithAwaitExpression_ProducesImperativeSegmentWithAwait()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.IsTrue(imperative.Operations
            .SelectMany(static operation => operation.DescendantsAndSelf())
            .Any(static operation => operation is IAwaitOperation));
    }

    [TestMethod]
    public void CreateRenderTree_WithAwaitForEach_ProducesImperativeLoopBlockWithAsyncForEach()
    {
        var context = CreateContext(
            """
            using System;
        ...
        Assert.IsTrue(imperative.Operations
            ...
            .Any(static operation => operation.IsAsynchronous));
    }

    [TestMethod]
    public void CreateRenderTree_WithAwaitUsingStatement_ProducesImperativeTryBlockWithAsyncUsing()
    {
        var context = CreateContext(
            """
            using System;
    ...
    [TestMethod]
    public void CreateRenderTree_WithAwaitUsingDeclaration_ProducesImperativeTryBlockWithAsyncUsingDeclaration()
    {
        var context = CreateContext(
            """
            using System;
