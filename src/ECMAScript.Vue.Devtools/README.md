...
资源由 `Jazor.Vue` manifest 声明的 embedded Vue runtime bridge 提供；调用方编写的插件模块
仍由自身的 Jazor 工具生成到程序集 `Jazor.Generated.ModuleCatalog`。
...
<ItemGroup>
  ...
  <PackageReference Include="Jazor.Vue" Version="1.0.0-preview.3" />
