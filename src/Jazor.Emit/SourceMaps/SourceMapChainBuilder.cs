...
internal sealed class SourceMapChainBuilder
{
    ...
    {
        ArgumentNullException.ThrowIfNull(bundleMap);
        ArgumentNullException.ThrowIfNull(moduleMapsByPath);
    ...
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(bundleMapJson);
        ArgumentNullException.ThrowIfNull(moduleMapJsonByPath);
