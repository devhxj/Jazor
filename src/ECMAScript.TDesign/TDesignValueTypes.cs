...
[Union]
[Description("@#")]
public readonly struct TDesignCssStyleValue : IUnion
{
    private readonly byte _kind;
    private readonly string? _string;
    private readonly VueProps? _props;
    private readonly TDesignCssStyleValues? _values;

    private TDesignCssStyleValue(string value)
    {
        _kind = 1;
        _string = value;
        _props = default;
    ...
    private TDesignCssStyleValue(VueProps value)
    {
        _kind = 2;
        _string = default;
        _props = value;
    ...
    private TDesignCssStyleValue(TDesignCssStyleValues value)
    {
        _kind = 3;
        _string = default;
        _props = default;
    ...
    public TDesignCssStyleValues? AsValues => _kind == 3 ? _values : default;
    ...
    public extern static TDesignCssStyleValue From(string value);

    [ECMAScriptInline("__arg1")]
    public extern static TDesignCssStyleValue From(VueProps value);

    [ECMAScriptInline("__arg1")]
    public extern static TDesignCssStyleValue From(TDesignCssStyleValues value);

    public static implicit operator TDesignCssStyleValue(string value)
        => new(value);

    public static implicit operator TDesignCssStyleValue(VueProps value)
        => new(value);

    public static implicit operator TDesignCssStyleValue(VueDictionary value)
        => new(value);

    public static implicit operator TDesignCssStyleValue(TDesignCssStyleValues value)
        => new(value);

    public static implicit operator TDesignCssStyleValue(TDesignCssStyleValue[] value)
        => new((TDesignCssStyleValues)value);
...
[Union]
[Description("@#")]
[CollectionBuilder(typeof(TDesignCssStyleValuesCollectionBuilder), nameof(TDesignCssStyleValuesCollectionBuilder.Create))]
public readonly struct TDesignCssStyleValues : IUnion, IEnumerable<TDesignCssStyleValue>
{
    private readonly TDesignCssStyleValue[]? _values;

    private TDesignCssStyleValues(TDesignCssStyleValue[] values)
    {
        _values = values;
    }

    public TDesignCssStyleValue[]? AsArray => _values;

    public object? Value => AsArray;

    [ECMAScriptInline("__arg1")]
    public extern static TDesignCssStyleValues From(TDesignCssStyleValue[] values);

    public static implicit operator TDesignCssStyleValues(TDesignCssStyleValue[] values)
        => new(values);

    public static implicit operator TDesignCssStyleValues(string[] values)
        => new(Array.ConvertAll(values, static value => (TDesignCssStyleValue)value));

    public static implicit operator TDesignCssStyleValues(VueProps[] values)
        => new(Array.ConvertAll(values, static value => (TDesignCssStyleValue)value));

    public static implicit operator TDesignCssStyleValues(VueDictionary[] values)
        => new(Array.ConvertAll(values, static value => (TDesignCssStyleValue)value));

    IEnumerator<TDesignCssStyleValue> IEnumerable<TDesignCssStyleValue>.GetEnumerator()
        => ((IEnumerable<TDesignCssStyleValue>)(_values ?? [])).GetEnumerator();

    IEnumerator IEnumerable.GetEnumerator()
        => ((IEnumerable<TDesignCssStyleValue>)this).GetEnumerator();
}

[EditorBrowsable(EditorBrowsableState.Never)]
public static class TDesignCssStyleValuesCollectionBuilder
{
    public static TDesignCssStyleValues Create(ReadOnlySpan<TDesignCssStyleValue> values)
        => values.ToArray();
}
