...
public static class WhiteList
{
    ...
    public static readonly HashSet<string> Members = new HashSet<string>
    {
        ...
        "override System.ValueTuple.Equals(object)",
        "System.ValueTuple.Equals(System.ValueTuple)",
        "System.ValueTuple.CompareTo(System.ValueTuple)",
        "override System.ValueTuple.GetHashCode()",
        "override System.ValueTuple.ToString()",
        "static System.ValueTuple.Create()",
        "static System.ValueTuple.Create<T1>(T1)",
        "static System.ValueTuple.Create<T1, T2>(T1, T2)",
        "static System.ValueTuple.Create<T1, T2, T3>(T1, T2, T3)",
        "static System.ValueTuple.Create<T1, T2, T3, T4>(T1, T2, T3, T4)",
        "static System.ValueTuple.Create<T1, T2, T3, T4, T5>(T1, T2, T3, T4, T5)",
        "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6>(T1, T2, T3, T4, T5, T6)",
        "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6, T7>(T1, T2, T3, T4, T5, T6, T7)",
        "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1, T2, T3, T4, T5, T6, T7, T8)"
    };
}