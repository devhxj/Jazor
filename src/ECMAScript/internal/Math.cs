...
public static partial class Global
{
	...
	extension(Math)
	{
		...
		[Description("@#expm1")]
		public extern static Number Exponential1(Number x);
		...
		public extern static Number F16round(Number x);
		...
		public extern static Number SumPrecise(IEnumerable<Number> items);
