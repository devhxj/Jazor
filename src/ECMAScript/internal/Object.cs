...
public static partial class Global
{
	...
	extension(object obj)
	{
		...
		public extern static TTarget DefineProperty<TTarget>(TTarget o, PropertyKeyRef p, PropertyDescriptorRef attributes);
		...
		public extern object? Get(PropertyKeyRef name);
		...
		public extern void Set(PropertyKeyRef name, object? value);
		...
		[ECMAScriptInline("__arg1[__arg2](...__arg3)")]
		public extern object? Invoke(PropertyKeyRef name, [Preserve] params object?[] args);
		...
		public extern void __defineGetter__(PropertyKeyRef property, Func<object?> getter);
		...
		public extern void __defineSetter__(PropertyKeyRef property, Action<object?> setter);
		...
		public extern Func<object?>? __lookupGetter__(PropertyKeyRef property);
		...
		public extern Action<object?>? __lookupSetter__(PropertyKeyRef property);
		...
		/// </summary>
		[Description("@#groupBy")]
		public extern static IObject GroupBy<T>(IEnumerable<T> items, Func<T, Number, PropertyKeyRef> callbackfn);
		...
		/// </summary>
		[Description("@#groupBy")]
		public extern static IObject GroupBy<T>(IEnumerable<T> items, Func<T, PropertyKeyRef> callbackfn);
		...
		[Description("@#hasOwn")]
		public extern static bool HasOwn(object o, PropertyKeyRef p);
