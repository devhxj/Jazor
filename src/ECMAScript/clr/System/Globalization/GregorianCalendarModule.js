...
/*jazor:clr-member override System.Globalization.GregorianCalendar.MinSupportedDateTime.get*/
export function _13ca7ecb3e3aade5(instance) {
  return _fad0c74e1c9df5bb();
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.MaxSupportedDateTime.get*/
export function _7ba83b2ccdd567b5(instance) {
  return _eb38dc04224730ea();
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.AlgorithmType.get*/
export function _2c293866a460d9ea(instance) {
  return 1;
}
/*jazor:clr-member System.Globalization.GregorianCalendar.GregorianCalendar()*/
export function _23b9e8d671b5210e() {
  return new JGregorianCalendar(get_LocalizedCalendarType(), get_DefaultTwoDigitYearMax());
}
/*jazor:clr-member System.Globalization.GregorianCalendar.GregorianCalendar(System.Globalization.GregorianCalendarTypes)*/
...
/*jazor:clr-member virtual System.Globalization.GregorianCalendar.CalendarType.get*/
export function _33a82cf70a73ecdd(instance) {
  return instance.calendarType;
}
/*jazor:clr-member virtual System.Globalization.GregorianCalendar.CalendarType.set*/
...
/*jazor:clr-member override System.Globalization.GregorianCalendar.AddMonths(System.DateTime, int)*/
export function _1c4bd410ce12db05(instance, time, months) {
  return _aae197b95f9024a4(time, months);
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.AddYears(System.DateTime, int)*/
export function _705c207141cada42(instance, time, years) {
  return _3353d31b02f2bed8(time, years);
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetDayOfMonth(System.DateTime)*/
export function _5f5d0a874674bdea(instance, time) {
  return time.date.getDate();
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetDayOfWeek(System.DateTime)*/
export function _6cdddcc68587ea95(instance, time) {
  return time.date.getDay();
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetDayOfYear(System.DateTime)*/
...
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetDaysInMonth(int, int, int)*/
export function _ce58c7d4d1c36fe3(instance, year, month, era) {
  ValidateEra(era);
  return GetDaysInMonth(year, month);
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetDaysInYear(int, int)*/
export function _7545c4d66f0f3604(instance, year, era) {
  ValidateEra(era);
  ValidateYear(year);
  return _4c3723e9b82aa507(instance, year, era) ? 366 : 365;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetEra(System.DateTime)*/
export function _21a6ebc60ed3b388(instance, time) {
  return 1;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.Eras.get*/
export function _c01c2927eaf2fefe(instance) {
  return [1];
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetMonth(System.DateTime)*/
export function _ce76f400b1aa26d3(instance, time) {
  return time.date.getMonth() + 1;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetMonthsInYear(int, int)*/
export function _5df8d3230f9681b9(instance, year, era) {
  ValidateEra(era);
  ValidateYear(year);
  return 12;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetYear(System.DateTime)*/
export function _fd5a2cde6fb4d6f5(instance, time) {
  return time.date.getFullYear();
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.IsLeapDay(int, int, int, int)*/
...
/*jazor:clr-member override System.Globalization.GregorianCalendar.GetLeapMonth(int, int)*/
export function _91a08597c1c93445(instance, year, era) {
  ValidateEra(era);
  ValidateYear(year);
  return 0;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.IsLeapMonth(int, int, int)*/
export function _9917941c9da950b5(instance, year, month, era) {
  ValidateEra(era);
  ValidateMonth(year, month);
  return false;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.IsLeapYear(int, int)*/
export function _4c3723e9b82aa507(instance, year, era) {
  ValidateEra(era);
  ValidateYear(year);
  return year % 4 === 0 && (year % 100 !== 0 || year % 400 === 0);
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.ToDateTime(int, int, int, int, int, int, int, int)*/
export function _29ccd13d5e5508f8(instance, year, month, day, hour, minute, second, millisecond, era) {
  ValidateEra(era);
  return new JDateTime("$ctor_31a0f1908d992f04", CreateLocalDateTime(year, month, day, hour, minute, second, millisecond), 0);
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.TwoDigitYearMax.get*/
export function _e32c11e11fbe2e3b(instance) {
  return instance.twoDigitYearMax;
}
/*jazor:clr-member override System.Globalization.GregorianCalendar.TwoDigitYearMax.set*/
...
/*jazor:clr-member override System.Globalization.GregorianCalendar.ToFourDigitYear(int)*/
