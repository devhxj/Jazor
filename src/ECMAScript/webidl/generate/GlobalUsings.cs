...
global using BinaryData = ECMAScript.Either<ECMAScript.ArrayBuffer, ECMAScript.IArrayBufferView>;
...
global using FencedFrameConfigSize = ECMAScript.Either<uint, ECMAScript.OpaqueProperty>;
global using FencedFrameConfigURL = string;
...
global using TimerHandler = ECMAScript.Either<string, System.Delegate>;
...
global using HTMLString = string;
global using ScriptString = string;
global using ScriptURLString = string;
...
global using UvmEntry = uint[];
global using UvmEntries = uint[]/*UvmEntry*/[];
global using ImageBufferSource = ECMAScript.Either<ECMAScript.IBufferSource, ECMAScript.ReadableStream>;
...
global using GPUBindingResource = ECMAScript.Either<ECMAScript.GPUBufferUsage.GPUSampler, ECMAScript.GPUBufferUsage.GPUTextureView, ECMAScript.GPUBufferUsage.GPUBufferBinding, ECMAScript.GPUBufferUsage.GPUExternalTexture>;
global using GPUPipelineConstantValue = double;
global using GPUColorWriteFlags = uint;
global using GPUImageCopyExternalImageSource = ECMAScript.Either<ECMAScript.ImageBitmap, ECMAScript.ImageData, ECMAScript.HTMLImageElement, ECMAScript.HTMLVideoElement, ECMAScript.VideoFrame, ECMAScript.HTMLCanvasElement, ECMAScript.OffscreenCanvas>;
...
global using MLNamedArrayBufferViews = System.Collections.Generic.Dictionary<string, ECMAScript.IArrayBufferView>;
