...
function CreateDateTimeOffset_f2ff91c46d03d8b1(utcDateTime, offsetTicks) {
  return CreateDateTimeOffset_f442cad46b92b9e6(utcDateTime, offsetTicks, get_ZeroTicks());
}
function CreateDateTimeOffset_f442cad46b92b9e6(utcDateTime, offsetTicks, utcSubMillisecondTicks) {
  ...
  return new JDateTimeOffset("$ctor_edd22711399c52b9", utcDateTime, offsetTicks, utcSubMillisecondTicks);
}
function CreateDefaultDateTimeOffset() {
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date(get_MinValueMilliseconds()), get_ZeroTicks());
}
function ValidateDateTimeOffsetRange(utcTicks, offsetTicks) {
  ValidateOffsetTicks(offsetTicks);
  if (utcTicks < get_ZeroTicks() || utcTicks > get_MaxDateTimeTicks())
...
function CreateFromUtcTicks(utcTicks, offsetTicks) {
  ...
  return CreateDateTimeOffset_f442cad46b92b9e6(new Date(Number(milliseconds)), offsetTicks, utcSubMillisecondTicks);
}
...
function CreateWithLocalOffset_ba94003d284edb26(utcDateTime) {
  let offsetTicks = BigInt(-utcDateTime.getTimezoneOffset()) * get_OffsetMinuteTicks();
  return CreateDateTimeOffset_f2ff91c46d03d8b1(utcDateTime, offsetTicks);
}
function CreateWithLocalOffset_7936bc6a8d621f87(utcTicks) {
...
function TryParseIsoDateTime(text, year, month, day, hour, minute, second, millisecond, subMillisecondTicks, hasExplicitOffset, offsetTicks) {
  let __ref$d725be7d91225e89b23728cd, __ref$5f81a7a17ce37bdd94b1b17c, __ref$b3f4e7d696533b6c7be9bdf8;
  year = 0;
  month = 0;
  day = 0;
  hour = 0;
  ...
  if (!(__ref$d725be7d91225e89b23728cd = TryParseIsoDate(text.substring(0, 0 + 10), undefined, undefined, undefined), year = __ref$d725be7d91225e89b23728cd[1], month = __ref$d725be7d91225e89b23728cd[2], day = __ref$d725be7d91225e89b23728cd[3], __ref$d725be7d91225e89b23728cd[0]))
    return [
      false,
      year,
      month,
  ...
  if (!(__ref$5f81a7a17ce37bdd94b1b17c = TryParseTwoDigits(text, 11, undefined), hour = __ref$5f81a7a17ce37bdd94b1b17c[1], __ref$5f81a7a17ce37bdd94b1b17c[0]) || _5ad63706a889c294(text, 13).charCodeAt(0) !== ":".charCodeAt(0) || !(__ref$b3f4e7d696533b6c7be9bdf8 = TryParseTwoDigits(text, 14, undefined), minute = __ref$b3f4e7d696533b6c7be9bdf8[1], __ref$b3f4e7d696533b6c7be9bdf8[0]))
    return [
      false,
      year,
      month,
  ...
  if (index < text.length && _5ad63706a889c294(text, index).charCodeAt(0) === ":".charCodeAt(0)) {
    let __ref$b0712d9038a77f2e2f4547b2;
    if (!(__ref$b0712d9038a77f2e2f4547b2 = TryParseTwoDigits(text, index + 1, undefined), second = __ref$b0712d9038a77f2e2f4547b2[1], __ref$b0712d9038a77f2e2f4547b2[0]))
      return [
        false,
        year,
        month,
  ...
  let offsetMinutes;
  if (remaining === 2) {
    let __ref$45ac6dc5d851e643f3b1f259;
    if (!(__ref$45ac6dc5d851e643f3b1f259 = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$45ac6dc5d851e643f3b1f259[1], __ref$45ac6dc5d851e643f3b1f259[0]))
      return [
        false,
        year,
        month,
    ...
    let __ref$45ac6dc5d851e643f3b1f259, __ref$9065c7b01231d5480e25979d;
    if (!(__ref$45ac6dc5d851e643f3b1f259 = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$45ac6dc5d851e643f3b1f259[1], __ref$45ac6dc5d851e643f3b1f259[0]) || !(__ref$9065c7b01231d5480e25979d = TryParseTwoDigits(text, index + 3, undefined), offsetMinutes = __ref$9065c7b01231d5480e25979d[1], __ref$9065c7b01231d5480e25979d[0]))
      return [
        false,
        year,
        month,
    ...
    let __ref$45ac6dc5d851e643f3b1f259, __ref$f5135326cd01421657f9bfb6;
    if (!(__ref$45ac6dc5d851e643f3b1f259 = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$45ac6dc5d851e643f3b1f259[1], __ref$45ac6dc5d851e643f3b1f259[0]) || !(__ref$f5135326cd01421657f9bfb6 = TryParseTwoDigits(text, index + 4, undefined), offsetMinutes = __ref$f5135326cd01421657f9bfb6[1], __ref$f5135326cd01421657f9bfb6[0]))
      return [
        false,
        year,
        month,
...
function TryParseTimeOnly(text, hour, minute, second, millisecond, subMillisecondTicks, hasExplicitOffset, offsetTicks) {
  let __ref$90886cbf61967e16d54174b9, __ref$15e35c430c9c5eaae8398cdc;
  hour = 0;
  minute = 0;
  second = 0;
  millisecond = 0;
  ...
  if (!(__ref$90886cbf61967e16d54174b9 = TryParseTwoDigits(text, 0, undefined), hour = __ref$90886cbf61967e16d54174b9[1], __ref$90886cbf61967e16d54174b9[0]) || _5ad63706a889c294(text, 2).charCodeAt(0) !== ":".charCodeAt(0) || !(__ref$15e35c430c9c5eaae8398cdc = TryParseTwoDigits(text, 3, undefined), minute = __ref$15e35c430c9c5eaae8398cdc[1], __ref$15e35c430c9c5eaae8398cdc[0]))
    return [
      false,
      hour,
      minute,
  ...
  let index = 5;
  if (index < text.length && _5ad63706a889c294(text, index).charCodeAt(0) === ":".charCodeAt(0)) {
    let __ref$a82d69fc172432207c814445;
    if (!(__ref$a82d69fc172432207c814445 = TryParseTwoDigits(text, index + 1, undefined), second = __ref$a82d69fc172432207c814445[1], __ref$a82d69fc172432207c814445[0]))
      return [
        false,
        hour,
        minute,
  ...
  let offsetMinutes;
  if (remaining === 2) {
    let __ref$1a8ee98553f465664be8143a;
    if (!(__ref$1a8ee98553f465664be8143a = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$1a8ee98553f465664be8143a[1], __ref$1a8ee98553f465664be8143a[0]))
      return [
        false,
        hour,
        minute,
    ...
    let __ref$1a8ee98553f465664be8143a, __ref$936b05d06b8dc7f6a40ec419;
    if (!(__ref$1a8ee98553f465664be8143a = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$1a8ee98553f465664be8143a[1], __ref$1a8ee98553f465664be8143a[0]) || !(__ref$936b05d06b8dc7f6a40ec419 = TryParseTwoDigits(text, index + 3, undefined), offsetMinutes = __ref$936b05d06b8dc7f6a40ec419[1], __ref$936b05d06b8dc7f6a40ec419[0]))
      return [
        false,
        hour,
        minute,
    ...
    let __ref$1a8ee98553f465664be8143a, __ref$2096f33b6cfd03658ac6d480;
    if (!(__ref$1a8ee98553f465664be8143a = TryParseTwoDigits(text, index + 1, undefined), offsetHours = __ref$1a8ee98553f465664be8143a[1], __ref$1a8ee98553f465664be8143a[0]) || !(__ref$2096f33b6cfd03658ac6d480 = TryParseTwoDigits(text, index + 4, undefined), offsetMinutes = __ref$2096f33b6cfd03658ac6d480[1], __ref$2096f33b6cfd03658ac6d480[0]))
      return [
        false,
        hour,
        minute,
...
function ResolveParsedOffsetTicks(input, parsedDate) {
  ...
  if (input.length >= 6) {
    let signIndex = input.length - 6;
    let sign = _5ad63706a889c294(input, signIndex);
    if ((sign.charCodeAt(0) === "+".charCodeAt(0) || sign.charCodeAt(0) === "-".charCodeAt(0)) && _5ad63706a889c294(input, input.length - 3).charCodeAt(0) === ":".charCodeAt(0)) {
      let hours = Number(((__jz_arg0, __jz_arg1, __jz_arg2) => __jz_arg0.substring(__jz_arg1, __jz_arg1 + __jz_arg2))(input, input.length - 5, 2));
      let minutes = Number(((__jz_arg0, __jz_arg1, __jz_arg2) => __jz_arg0.substring(__jz_arg1, __jz_arg1 + __jz_arg2))(input, input.length - 2, 2));
      if (signIndex > timeIndex && !isNaN(hours) && !isNaN(minutes) && minutes >= 0 && minutes < 60) {
        ...
        return sign.charCodeAt(0) === "-".charCodeAt(0) ? -ticks : ticks;
      }
    }
  }
  if (input.length >= 5) {
    ...
    let sign = _5ad63706a889c294(input, signIndex);
    if (sign.charCodeAt(0) === "+".charCodeAt(0) || sign.charCodeAt(0) === "-".charCodeAt(0)) {
      let hours = Number(((__jz_arg0, __jz_arg1, __jz_arg2) => __jz_arg0.substring(__jz_arg1, __jz_arg1 + __jz_arg2))(input, input.length - 4, 2));
      let minutes = Number(((__jz_arg0, __jz_arg1, __jz_arg2) => __jz_arg0.substring(__jz_arg1, __jz_arg1 + __jz_arg2))(input, input.length - 2, 2));
      if (signIndex > timeIndex && !isNaN(hours) && !isNaN(minutes) && minutes >= 0 && minutes < 60) {
        let ticks = BigInt(hours * 60 + minutes) * get_OffsetMinuteTicks();
        return sign.charCodeAt(0) === "-".charCodeAt(0) ? -ticks : ticks;
  ...
  if (input.length >= 3) {
    ...
    let sign = _5ad63706a889c294(input, signIndex);
    if (sign.charCodeAt(0) === "+".charCodeAt(0) || sign.charCodeAt(0) === "-".charCodeAt(0)) {
      let hours = Number(((__jz_arg0, __jz_arg1, __jz_arg2) => __jz_arg0.substring(__jz_arg1, __jz_arg1 + __jz_arg2))(input, input.length - 2, 2));
...
function ParseCore(input) {
  let timeHour, timeMinute, timeSecond, timeMillisecond, timeSubMillisecondTicks, timeHasExplicitOffset, timeOffsetTicks, __ref$ea6771b7631b140385c4abeb, year, month, day, __ref$657cba84c4bb2d090f03be92, hour, minute, second, millisecond, subMillisecondTicks, hasExplicitOffset, offsetTicks, __ref$2268e00158b7740c6546f358;
  let s = input.trim();
  if (s.length === 0)
    throw new Error("FormatException: String was not recognized as a valid DateTimeOffset.");
  if (__ref$ea6771b7631b140385c4abeb = TryParseTimeOnly(s, undefined, undefined, undefined, undefined, undefined, undefined, undefined), timeHour = __ref$ea6771b7631b140385c4abeb[1], timeMinute = __ref$ea6771b7631b140385c4abeb[2], timeSecond = __ref$ea6771b7631b140385c4abeb[3], timeMillisecond = __ref$ea6771b7631b140385c4abeb[4], timeSubMillisecondTicks = __ref$ea6771b7631b140385c4abeb[5], timeHasExplicitOffset = __ref$ea6771b7631b140385c4abeb[6], timeOffsetTicks = __ref$ea6771b7631b140385c4abeb[7], __ref$ea6771b7631b140385c4abeb[0]) {
    let now = new Date;
  ...
  if (__ref$657cba84c4bb2d090f03be92 = TryParseIsoDate(s, undefined, undefined, undefined), year = __ref$657cba84c4bb2d090f03be92[1], month = __ref$657cba84c4bb2d090f03be92[2], day = __ref$657cba84c4bb2d090f03be92[3], __ref$657cba84c4bb2d090f03be92[0]) {
    let date = CreateLocalDate(year, month, day);
    let utcTicks = BigInt(date.getTime()) * get_TicksPerMillisecond() + get_UnixEpochTicks();
    return CreateWithLocalOffset_7936bc6a8d621f87(utcTicks);
  }
  if (__ref$2268e00158b7740c6546f358 = TryParseIsoDateTime(s, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined), year = __ref$2268e00158b7740c6546f358[1], month = __ref$2268e00158b7740c6546f358[2], day = __ref$2268e00158b7740c6546f358[3], hour = __ref$2268e00158b7740c6546f358[4], minute = __ref$2268e00158b7740c6546f358[5], second = __ref$2268e00158b7740c6546f358[6], millisecond = __ref$2268e00158b7740c6546f358[7], subMillisecondTicks = __ref$2268e00158b7740c6546f358[8], hasExplicitOffset = __ref$2268e00158b7740c6546f358[9], offsetTicks = __ref$2268e00158b7740c6546f358[10], __ref$2268e00158b7740c6546f358[0]) {
...
/*jazor:clr-member static readonly System.DateTimeOffset.MinValue*/
export function _77107f0c23675b69() {
  return CreateDefaultDateTimeOffset();
}
/*jazor:clr-member static readonly System.DateTimeOffset.MaxValue*/
export function _d45d439f0b97ae0e() {
  return CreateDateTimeOffset_f442cad46b92b9e6(new Date(253402300799999), get_ZeroTicks(), BigInt("9999"));
}
/*jazor:clr-member static readonly System.DateTimeOffset.UnixEpoch*/
export function _087cabaedc1b5cc2() {
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date(0), get_ZeroTicks());
}
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset()*/
export function _12b4f3f1dc14bea9() {
  return CreateDefaultDateTimeOffset();
}
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(long, System.TimeSpan)*/
export function _1e9c5d2a64e6d41d(ticks, offset) {
  ValidateOffset(offset);
  return CreateFromUtcTicks(ticks - offset.ticks, offset.ticks);
}
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(System.DateTime)*/
export function _7adf69a53659433a(dateTime) {
  ...
  return CreateWithLocalOffset_7936bc6a8d621f87(instantTicks);
}
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(System.DateTime, System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(System.DateOnly, System.TimeOnly, System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(int, int, int, int, int, int, System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(int, int, int, int, int, int, int, System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(int, int, int, int, int, int, int, System.Globalization.Calendar, System.TimeSpan)*/
export function _61ea80919619bab9(year, month, day, hour, minute, second, millisecond, calendar, offset) {
  RequireGregorianCalendar(calendar);
  return _6abaa2b2082f575c(year, month, day, hour, minute, second, millisecond, offset);
}
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(int, int, int, int, int, int, int, int, System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.DateTimeOffset(int, int, int, int, int, int, int, int, System.Globalization.Calendar, System.TimeSpan)*/
export function _d027561c1f6af451(year, month, day, hour, minute, second, millisecond, microsecond, calendar, offset) {
  RequireGregorianCalendar(calendar);
  return _04123d597aa761a3(year, month, day, hour, minute, second, millisecond, microsecond, offset);
}
/*jazor:clr-member static System.DateTimeOffset.UtcNow.get*/
export function _7f444d9ce7391e15() {
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date, get_ZeroTicks());
}
/*jazor:clr-member System.DateTimeOffset.DateTime.get*/
export function _2b7dd675863ae961(instance) {
  let localTicks = GetTicks(instance);
  return new JDateTime("$ctor_9eb10cd821441a68", CreateLocalDateTime(Number(_127105b7a40a7665(instance)), Number(_79eb4c93cea58d59(instance)), Number(_ba8df912681fe784(instance)), Number(_b7fc65477ef4df45(instance)), Number(_0fe8054b55f9f1c7(instance)), Number(_822de224fed5bb6b(instance)), Number(_0c1b2675cd7a2faa(instance))), 0, NormalizeSubMillisecondTicks(localTicks));
}
/*jazor:clr-member System.DateTimeOffset.UtcDateTime.get*/
export function _703902cecd7f61dd(instance) {
  let utc = instance.utcDateTime;
  return new JDateTime("$ctor_9eb10cd821441a68", CreateLocalDateTime(utc.getUTCFullYear(), utc.getUTCMonth() + 1, utc.getUTCDate(), utc.getUTCHours(), utc.getUTCMinutes(), utc.getUTCSeconds(), utc.getUTCMilliseconds()), get_DateTimeKindUtc(), instance.utcSubMillisecondTicks);
}
/*jazor:clr-member System.DateTimeOffset.LocalDateTime.get*/
export function _ffbfe7b660ff0527(instance) {
  return new JDateTime("$ctor_9eb10cd821441a68", new Date(instance.utcDateTime.getTime()), get_DateTimeKindLocal(), instance.utcSubMillisecondTicks);
}
/*jazor:clr-member System.DateTimeOffset.ToOffset(System.TimeSpan)*/
export function _d1996f02ed3fa243(instance, offset) {
  ValidateOffset(offset);
  return CreateDateTimeOffset_f442cad46b92b9e6(new Date(instance.utcDateTime.getTime()), offset.ticks, instance.utcSubMillisecondTicks);
}
/*jazor:clr-member System.DateTimeOffset.Date.get*/
export function _d7098a1eabebc945(instance) {
  let local = new Date(instance.utcDateTime.getTime() + Number(instance.offsetTicks) / 10000);
  return new JDateTime("$ctor_31a0f1908d992f04", CreateLocalDate(local.getUTCFullYear(), local.getUTCMonth() + 1, local.getUTCDate()), 0);
}
/*jazor:clr-member System.DateTimeOffset.Day.get*/
export function _ba8df912681fe784(instance) {
  let local = new Date(instance.utcDateTime.getTime() + Number(instance.offsetTicks) / 10000);
  return local.getUTCDate();
}
/*jazor:clr-member System.DateTimeOffset.DayOfWeek.get*/
export function _17d30a204818ce34(instance) {
  let local = new Date(instance.utcDateTime.getTime() + Number(instance.offsetTicks) / 10000);
  return local.getUTCDay();
}
/*jazor:clr-member System.DateTimeOffset.DayOfYear.get*/
...
/*jazor:clr-member System.DateTimeOffset.Year.get*/
export function _127105b7a40a7665(instance) {
  let local = new Date(instance.utcDateTime.getTime() + Number(instance.offsetTicks) / 10000);
  return local.getUTCFullYear();
}
/*jazor:clr-member System.DateTimeOffset.Add(System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.AddDays(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddHours(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddMilliseconds(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddMicroseconds(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddMinutes(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddMonths(int)*/
export function _db8ffdb562d3ac68(instance, months) {
  return AddMonthsCore(instance, months);
}
/*jazor:clr-member System.DateTimeOffset.AddSeconds(double)*/
...
/*jazor:clr-member System.DateTimeOffset.AddTicks(long)*/
...
/*jazor:clr-member System.DateTimeOffset.AddYears(int)*/
...
/*jazor:clr-member static System.DateTimeOffset.Compare(System.DateTimeOffset, System.DateTimeOffset)*/
...
/*jazor:clr-member System.DateTimeOffset.CompareTo(System.DateTimeOffset)*/
export function _255c7bf4a2c3c663(instance, other) {
  return _56ac26a94d0f9bca(instance, other);
}
/*jazor:clr-member System.DateTimeOffset.CompareTo(object)*/
export function _f7f499e8872c8e8a(instance, other) {
  if (other === null)
    return 1;
  let value = other instanceof JDateTimeOffset ? other : null;
  if (value === null)
    throw new Error("ArgumentException: Object must be of type DateTimeOffset.");
  return _56ac26a94d0f9bca(instance, value);
}
/*jazor:clr-member override System.DateTimeOffset.Equals(object)*/
export function _fbec90dd4b315acd(instance, obj) {
  let other = obj instanceof JDateTimeOffset ? obj : null;
  if (other === null)
    return false;
  return _5a55745cbe84c163(instance, other);
}
/*jazor:clr-member System.DateTimeOffset.Equals(System.DateTimeOffset)*/
export function _5a55745cbe84c163(instance, other) {
  return GetUtcTicks(instance) === GetUtcTicks(other);
}
/*jazor:clr-member System.DateTimeOffset.EqualsExact(System.DateTimeOffset)*/
...
/*jazor:clr-member static System.DateTimeOffset.Equals(System.DateTimeOffset, System.DateTimeOffset)*/
export function _817d2f7b0e423bec(first, second) {
  return _5a55745cbe84c163(first, second);
}
/*jazor:clr-member static System.DateTimeOffset.FromFileTime(long)*/
export function _1185de87a3489deb(fileTime) {
  ...
  return CreateWithLocalOffset_7936bc6a8d621f87(fileTime - get_FileTimeUnixEpochTicks() + get_UnixEpochTicks());
}
/*jazor:clr-member static System.DateTimeOffset.FromUnixTimeSeconds(long)*/
export function _fb7d72712794a2e4(seconds) {
  ...
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date(Number(seconds * BigInt(1000))), get_ZeroTicks());
}
/*jazor:clr-member static System.DateTimeOffset.FromUnixTimeMilliseconds(long)*/
export function _89071e7da78164f5(milliseconds) {
  ...
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date(Number(milliseconds)), get_ZeroTicks());
}
/*jazor:clr-member override System.DateTimeOffset.GetHashCode()*/
export function _484d626eb36d071d(instance) {
  return GetInt64HashCode(GetUtcTicks(instance));
}
/*jazor:clr-member static System.DateTimeOffset.Parse(string)*/
export function _25187a24d190d864(input) {
  return ParseCore(input);
}
/*jazor:clr-member static System.DateTimeOffset.Parse(string, System.IFormatProvider)*/
export function _fbb732b1255fdd38(input, formatProvider) {
  return ParseCore(input);
}
/*jazor:clr-member static System.DateTimeOffset.Parse(string, System.IFormatProvider, System.Globalization.DateTimeStyles)*/
export function _277a1a2c7845bcdc(input, formatProvider, styles) {
  return ApplyDateTimeStyles(ParseCore(input), input, styles);
}
/*jazor:clr-member static System.DateTimeOffset.Parse(System.ReadOnlySpan<char>, System.IFormatProvider, System.Globalization.DateTimeStyles)*/
export function _948a165174740d96(input, formatProvider, styles) {
  return ApplyDateTimeStyles(ParseCore(input), input, styles);
}
/*jazor:clr-member System.DateTimeOffset.Subtract(System.DateTimeOffset)*/
export function _f1e08916de33ed2a(instance, value) {
  return new JTimeSpan(GetUtcTicks(instance) - GetUtcTicks(value));
}
/*jazor:clr-member System.DateTimeOffset.Subtract(System.TimeSpan)*/
...
/*jazor:clr-member System.DateTimeOffset.ToLocalTime()*/
export function _c45ea6b7c8ed9501(instance) {
  return CreateWithLocalOffset_7936bc6a8d621f87(GetUtcTicks(instance));
}
/*jazor:clr-member override System.DateTimeOffset.ToString()*/
export function _2aaccc10061a3bb0(instance) {
  return FormatDateTimeOffset(instance, null, null);
}
/*jazor:clr-member System.DateTimeOffset.ToString(string)*/
export function _9b46cc87f855c6ba(instance, format) {
  return FormatDateTimeOffset(instance, format, null);
}
/*jazor:clr-member System.DateTimeOffset.ToString(System.IFormatProvider)*/
export function _f0d70d071309b539(instance, formatProvider) {
  return FormatDateTimeOffset(instance, null, formatProvider);
}
/*jazor:clr-member System.DateTimeOffset.ToString(string, System.IFormatProvider)*/
...
/*jazor:clr-member System.DateTimeOffset.ToUniversalTime()*/
export function _cbe0bd9bc2e35d83(instance) {
  return CreateDateTimeOffset_f442cad46b92b9e6(new Date(instance.utcDateTime.getTime()), get_ZeroTicks(), instance.utcSubMillisecondTicks);
}
/*jazor:clr-member static System.DateTimeOffset.TryParse(string, out System.DateTimeOffset)*/
...
/*jazor:clr-member static System.DateTimeOffset.TryParse(System.ReadOnlySpan<char>, out System.DateTimeOffset)*/
export function _c7957aa2e68f8218(input, result) {
  return _2fd90dc37b274014(input, result);
}
/*jazor:clr-member static System.DateTimeOffset.TryParse(string, System.IFormatProvider, System.Globalization.DateTimeStyles, out System.DateTimeOffset)*/
...
/*jazor:clr-member static System.DateTimeOffset.TryParse(System.ReadOnlySpan<char>, System.IFormatProvider, System.Globalization.DateTimeStyles, out System.DateTimeOffset)*/
...
/*jazor:clr-member static System.DateTimeOffset.implicit operator System.DateTimeOffset(System.DateTime)*/
export function _31bbd12ed57f4f76(value) {
  ...
  return CreateWithLocalOffset_7936bc6a8d621f87(GetDateTimeInstantTicks(value));
}
/*jazor:clr-member static System.DateTimeOffset.operator +(System.DateTimeOffset, System.TimeSpan)*/
...
/*jazor:clr-member static System.DateTimeOffset.operator -(System.DateTimeOffset, System.DateTimeOffset)*/
...
/*jazor:clr-member System.DateTimeOffset.Deconstruct(out System.DateOnly, out System.TimeOnly, out System.TimeSpan)*/
...
/*jazor:clr-member static System.DateTimeOffset.TryParse(string, System.IFormatProvider, out System.DateTimeOffset)*/
export function _61ef673e0dd00ab0(s, provider, result) {
  return _2fd90dc37b274014(s, result);
}
/*jazor:clr-member static System.DateTimeOffset.Parse(System.ReadOnlySpan<char>, System.IFormatProvider)*/
export function _b0967252268296ed(s, provider) {
  return ParseCore(s);
}
/*jazor:clr-member static System.DateTimeOffset.TryParse(System.ReadOnlySpan<char>, System.IFormatProvider, out System.DateTimeOffset)*/
export function _c9e042e683205a8b(s, provider, result) {
  return _2fd90dc37b274014(s, result);
}
/*jazor:clr-member static System.DateTimeOffset.Now.get*/
export function _e679a7abf50cf648() {
  let now = new Date;
  let offsetTicks = BigInt(-now.getTimezoneOffset()) * get_OffsetMinuteTicks();
  return CreateDateTimeOffset_f2ff91c46d03d8b1(new Date(now.getTime()), offsetTicks);
}
