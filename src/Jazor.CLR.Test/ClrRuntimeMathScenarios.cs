...
internal static class ClrRuntimeMathScenarios
{
    ...
    [
        ...
        Success("math.abs.decimal", "static System.Math.Abs(decimal)", [Text("-123.4500")], Text("123.45")),
        ...
        Success("math.max.decimal-normalizes-result", "static System.Math.Max(decimal, decimal)", [Text("1.20"), Text("1.2")], Text("1.2")),
