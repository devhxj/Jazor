...
internal static class ClrRuntimeMathScenarios
{
    ...
    [
        ...
        Failure("math.abs.sbyte.minimum-overflow", "static System.Math.Abs(sbyte)", [Number(sbyte.MinValue)], "OverflowException"),
        Failure("math.abs.short.minimum-overflow", "static System.Math.Abs(short)", [Number(short.MinValue)], "OverflowException"),
        Failure("math.abs.int.minimum-overflow", "static System.Math.Abs(int)", [Number(int.MinValue)], "OverflowException"),
        Failure("math.abs.long.minimum-overflow", "static System.Math.Abs(long)", [Big(long.MinValue)], "OverflowException"),
