...
internal static class ClrRuntimeReadOnlyCollectionScenarios
{
    ...
    [
        ...
        Success("enumerable.all.predicate-zero-is-positive", "static System.Linq.Enumerable.All<TSource>(System.Collections.Generic.IEnumerable<TSource>, System.Func<TSource, bool>)", EnumerableModulePath, [Array(Number(0)), Callable(ClrRuntimeCallableKind.IsPositive)], Bool(true)),
