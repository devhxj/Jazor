...
{
    private const string ModulePath = "clr/System/SingleModule.js";
    ...
    [
        ...
        Success("single.round.exact-digits", "static float.Round(float, int)", [Number(1.5), Number(1)], Number(float.Round(1.5f, 1))),
        Success("single.round.away-from-zero", "static float.Round(float, System.MidpointRounding)", [Number(-2.5), Number(1)], Number(-3)),
        Success("single.round.exact-away-from-zero", "static float.Round(float, System.MidpointRounding)", [Number(1), Number(1)], Number(float.Round(1, MidpointRounding.AwayFromZero))),
