...
internal static class ClrRuntimeDecimalScenarios
{
    ...
    [
        ...
        Failure("decimal.parse.rejects-oversized-exponent", "static decimal.Parse(string, System.Globalization.NumberStyles, System.IFormatProvider)", [Text("1e999999999"), Number(FloatStyle), Text("")], "FormatException"),
        ...
        Success("decimal.try-parse.oversized-exponent", "static decimal.TryParse(string, System.Globalization.NumberStyles, System.IFormatProvider, out decimal)", [Text("1e999999999"), Number(FloatStyle), Text(""), Text("9")], Array(Bool(false), Text("0"))),
