...
internal static class ClrRuntimeIntegralScenarios
{
    ...
    [
        ...
        Failure("int64.abs.minimum-overflow", "static long.Abs(long)", Int64ModulePath, [BigInt(long.MinValue)], "OverflowException"),
        Failure("int64.parse.invalid-format", "static long.Parse(string)", Int64ModulePath, [Text("17px")], "FormatException"),
        Failure("int64.parse.javascript-hex-is-invalid", "static long.Parse(string)", Int64ModulePath, [Text("0x10")], "FormatException"),
		...
		Success("int64.try-parse.javascript-hex-is-invalid", "static long.TryParse(string, out long)", Int64ModulePath, [Text("0x10"), BigInt(99)], Array(Bool(false), BigInt(0))),
        ...
        Failure("int16.abs.minimum-overflow", "static short.Abs(short)", Int16ModulePath, [Number(-32768)], "OverflowException"),
        ...
        Failure("sbyte.abs.minimum-overflow", "static sbyte.Abs(sbyte)", SByteModulePath, [Number(-128)], "OverflowException"),
		...
		Failure("int32.abs.minimum-overflow", "static int.Abs(int)", Int32ModulePath, [Number(int.MinValue)], "OverflowException"),
        ...
        Failure("uint64.parse.javascript-hex-is-invalid", "static ulong.Parse(string)", UInt64ModulePath, [Text("0x10")], "FormatException"),
		...
		Success("uint64.try-parse.javascript-hex-is-invalid", "static ulong.TryParse(string, out ulong)", UInt64ModulePath, [Text("0x10"), BigInt(99)], Array(Bool(false), BigInt(0))),
