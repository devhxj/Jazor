...
internal static class ClrRuntimeDoubleScenarios
{
    ...
    [
        ...
        Success("double.is-pow2.large-neighbor-is-not-power", "static double.IsPow2(double)", [Number(Math.Pow(2, 100) + Math.Pow(2, 48))], Bool(false)),
        Success("double.is-pow2.infinity", "static double.IsPow2(double)", [Number(double.PositiveInfinity)], Bool(false)),
        Success("double.root-n.negative-odd", "static double.RootN(double, int)", [Number(-8), Number(3)], Number(-2)),
        Success("double.root-n.negative-even-is-nan", "static double.RootN(double, int)", [Number(-8), Number(2)], Number(double.NaN)),
        ...
        Success("double.round.exact-digits", "static double.Round(double, int)", [Number(1.5), Number(1)], Number(double.Round(1.5, 1))),
        Success("double.round.away-from-zero", "static double.Round(double, System.MidpointRounding)", [Number(-2.5), Number(1)], Number(-3)),
        Success("double.round.exact-away-from-zero", "static double.Round(double, System.MidpointRounding)", [Number(1), Number(1)], Number(double.Round(1, MidpointRounding.AwayFromZero))),
