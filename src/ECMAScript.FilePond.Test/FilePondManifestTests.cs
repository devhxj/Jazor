...
/// <summary>
/// File-backed manifest, inventory, and upstream drift checks for the vendored FilePond runtime.
...
{
    [TestMethod]
    public void FilePond_Manifest_DeclaresLockedClosureWithVerifiableHashes()
    {
        ...
        CollectionAssert.AreEquivalent(
            new[] { "dist/filepond/filepond.css" },
    ...
    [TestMethod]
    public void FilePond_VendoredDist_ExactlyMatchesTheManifestClosure()
    {
        using var manifest = JsonDocument.Parse(File.ReadAllText(GetProjectPath("manifest.json")));
    ...
    [TestMethod]
    public void FilePond_VendoredModules_AreBrowserSafe()
    {
    ...
    [TestMethod]
    public void FilePond_BoundExports_ExistInTheUpstreamEntry()
    {
    ...
    private static IEnumerable<string> Entries => new[] { GetProjectPath("dist", "filepond", "filepond.esm.js"), GetProjectPath("dist", "vue-filepond", "vue-filepond.esm.js") };
