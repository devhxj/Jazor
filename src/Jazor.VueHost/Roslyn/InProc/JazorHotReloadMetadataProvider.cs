...
internal sealed class JazorHotReloadMetadataProvider
{
        ...
        IReadOnlyList<DocumentSnapshot> companionDocuments)
    {
        ...
        var supportTree = CSharpSyntaxTree.ParseText(
            CreateSupportSource(),
            ParseOptions,
            path: "virtual:Jazor.VueHost.HotReloadSupport.g.cs",
            encoding: Encoding.UTF8);
        var compilation = CSharpCompilation.Create(
            assemblyName: "__JazorVueHostHotReloadMetadata",
        ...
        IReadOnlyList<DocumentSnapshot>? companionDocuments)
    {
        ...
        var candidatePaths = VueHostWorkspaceResolver.GetCoLocatedCodeBehindPaths(jazorDocumentPath)
            .Select(VueHostWorkspaceResolver.NormalizePath)
        ...
        foreach (var candidatePath in VueHostWorkspaceResolver.GetCoLocatedCodeBehindPaths(jazorDocumentPath))
        {
