...
internal sealed class RazorSdkToolsetResolver
{
    ...
    private const string BundledSdkEnvironmentVariable = "JAZOR_VUEHOST_DOTNET_ROOT";
    private const string BundledSdkVersionEnvironmentVariable = "JAZOR_VUEHOST_DOTNET_SDK_VERSION";
