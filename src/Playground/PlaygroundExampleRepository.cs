...
internal sealed class PlaygroundExampleRepository
{
    ...
    [
        new(
            ...
            ["Playground/Program.cs", "Playground/Pages/PlaygroundCatalogPage.razor", "consumer/src/bootstrap-app.js"],
        ...
        new(
            ...
            ["consumer/src/stores/playground-store.js", "consumer/src/bootstrap-app.js"],
            "2026-05-12T00:00:00Z",
            true,
            14),
        new(
            ...
            ["Catalog and detail routes projected from Razor @page", "Search query retention", "404-safe fallback and host-side shell delivery"],
            ["Create web history using the deployed base path.", "Project catalog/detail routes from unified jazor-manifest.json metadata.", "Keep host fallback handling aligned with client navigation."],
            ["consumer/src/router.js", "Jazor.Emit/RazorVueConsumerEntryCompiler.cs", "Playground/wwwroot/index.html"],
            "2026-05-12T00:00:00Z",
            true,
            12),
        new(
