...
// <auto-generated />
// Generated from:
// - src/ECMAScript.Vue.Generator/upstream/element-plus/2.14.5/web-types.json
// - src/ECMAScript.Vue.Generator/upstream/element-plus/2.14.5/attributes.json
// - src/ECMAScript.Vue.Generator/upstream/element-plus/2.14.5/es/component.mjs
...
public sealed class ElDatePickerPanel : ElContentComponentBase
{
    ...
    /// <summary>
    /// whether to show footer where the date picker is one ^[enum]`'dates' | 'months' | 'years' | 'quarters' | 'datetime' | 'datetimerange'`
    /// </summary>
    [Parameter]
    [ECMAScriptName("showFooter")]
    public bool? ShowFooter { get; set; }
