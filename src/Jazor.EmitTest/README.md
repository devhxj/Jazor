...
- Independent referenced-package catalogs, including `ECMAScript.Style` debug materialization, source maps, manifests, and release bundles.
...
- `CatalogReader_TryRead_ReadsEcmaScriptStyleRuntimeWithSourceMap`
- `Build_LocalEcmaScriptStylePackage_DebugMaterializesAndReleaseBundlesRuntime`
