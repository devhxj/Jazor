...
const interfaceMixins = new Map();
const interfaceIncludes = [];
...
const generateCallbackInterface = function (item, namespace = undefined) {
    ...
    const code = operations.map(member => {
...
// 7������ȫ��using
fs.writeFileSync(`${targetDir}/GlobalUsings.cs`, commonUsings.concat(globalUsings).join(N), { encoding: 'utf8' });
