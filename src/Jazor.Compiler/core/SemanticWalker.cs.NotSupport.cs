...
public partial class SemanticWalker
{
	...
	public override Node? VisitUsing(IUsingOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitStop(IStopOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitEnd(IEndOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitRaiseEvent(IRaiseEventOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitForToLoop(IForToLoopOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitLock(ILockOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitEventReference(IEventReferenceOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitEventAssignment(IEventAssignmentOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicObjectCreation(IDynamicObjectCreationOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicMemberReference(IDynamicMemberReferenceOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicInvocation(IDynamicInvocationOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicIndexerAccess(IDynamicIndexerAccessOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitTranslatedQuery(ITranslatedQueryOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitTypeOf(ITypeOfOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitSizeOf(ISizeOfOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitAddressOf(IAddressOfOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitMethodBodyOperation(IMethodBodyOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitConstructorBodyOperation(IConstructorBodyOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitCaughtException(ICaughtExceptionOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitStaticLocalInitializationSemaphore(IStaticLocalInitializationSemaphoreOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowAnonymousFunction(IFlowAnonymousFunctionOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitRangeCaseClause(IRangeCaseClauseOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowCapture(IFlowCaptureOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowCaptureReference(IFlowCaptureReferenceOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitRelationalCaseClause(IRelationalCaseClauseOperation operation, WalkerArgument argument)
	...
	public override Node? VisitRangeOperation(IRangeOperation operation, WalkerArgument argument)
	{
		// 检查是否在数组元素访问的上下文中
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitReDim(IReDimOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitReDimClause(IReDimClauseOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitUsingDeclaration(IUsingDeclarationOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringHandlerCreation(IInterpolatedStringHandlerCreationOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringAppend(IInterpolatedStringAppendOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringHandlerArgumentPlaceholder(IInterpolatedStringHandlerArgumentPlaceholderOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFunctionPointerInvocation(IFunctionPointerInvocationOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitUtf8String(IUtf8StringOperation operation, WalkerArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInlineArrayAccess(IInlineArrayAccessOperation operation, WalkerArgument argument)
