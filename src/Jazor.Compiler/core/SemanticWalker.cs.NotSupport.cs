...
public partial class SemanticWalker
{
	...
	public override Node? VisitStop(IStopOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitEnd(IEndOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitRaiseEvent(IRaiseEventOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicObjectCreation(IDynamicObjectCreationOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicMemberReference(IDynamicMemberReferenceOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicInvocation(IDynamicInvocationOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitDynamicIndexerAccess(IDynamicIndexerAccessOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitAddressOf(IAddressOfOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitCaughtException(ICaughtExceptionOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitStaticLocalInitializationSemaphore(IStaticLocalInitializationSemaphoreOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowAnonymousFunction(IFlowAnonymousFunctionOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitRangeCaseClause(IRangeCaseClauseOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowCapture(IFlowCaptureOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFlowCaptureReference(IFlowCaptureReferenceOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitReDim(IReDimOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringHandlerCreation(IInterpolatedStringHandlerCreationOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringAppend(IInterpolatedStringAppendOperation operation, SenseArgument argument)
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitInterpolatedStringHandlerArgumentPlaceholder(IInterpolatedStringHandlerArgumentPlaceholderOperation operation, SenseArgument argument)
...
#pragma warning restore RSEXPERIMENTAL006
	...
	/// <param name="argument">用于存放当前operation内部需要的全局变量定义</param>
	/// <returns>Acornima的ESTree的Node</returns>
	public override Node? VisitFunctionPointerInvocation(IFunctionPointerInvocationOperation operation, SenseArgument argument)
