...
internal static class TDesignBindingGenerator
{
    ...
    sealed record ComponentMetadata(
        string Tag,
        string SourceExport,
    ...
    sealed record TsTypeParameter(string Name, string? DefaultType);

    sealed record ComponentContract(
        string Tag,
        string AuthoringType,
        string? PropsDeclaration,
    ...
    static class TypeScriptDeclarations
    {
