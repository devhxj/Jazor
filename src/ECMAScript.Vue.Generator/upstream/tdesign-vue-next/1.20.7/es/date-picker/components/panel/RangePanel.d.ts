...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    range: PropType<TdDateRangePickerProps["range"]>;
    activeIndex: NumberConstructor;
    isFirstValueSelected: BooleanConstructor;
    disabled: {
        type: PropType<TdDateRangePickerProps["disabled"]>;
    };
    disableDate: PropType<TdDateRangePickerProps["disableDate"]>;
    disableTime: PropType<TdDateRangePickerProps["disableTime"]>;
    mode: {
    ...
    defaultTime: PropType<TdDateRangePickerProps["defaultTime"]>;
    ...
    cell: {
        type: PropType<TdDateRangePickerProps["cell"]>;
    };
