...
export declare function useVModel(props: TreeProps & Record<string, any>, refsProps: ToRefs<TreeProps> & Record<string, any>, propName?: string, defaultPropName?: string, eventPropName?: string, eventName?: string): [Vue.Ref<any, any>, import("@tdesign/shared-hooks").ChangeHandler<any, any[]>];
