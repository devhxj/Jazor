...
export default function usePagination(props: TdBaseTableProps, context: SetupContext, tableContentRef: Ref<HTMLElement | null>): {
    isPaginateData: Ref<boolean, boolean>;
    dataSource: Ref<{
        [x: string]: any;
        children?: any[];
    }[], TableRowData[] | {
    ...
    renderPagination: () => import("vue/jsx-runtime").JSX.Element;
};
