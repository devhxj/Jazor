...
import TableTreeStore from 'tdesign-vue-next/es/common/js/table/tree-store';
export declare function useTreeDataExpand(props: TdEnhancedTableProps, params: {
    ...
    tExpandedTreeNode: Ref<(string | number)[], (string | number)[]>;
    isDefaultExpandAllExecute: Ref<boolean, boolean>;
    isDefaultExpandedTreeNodesExecute: Ref<boolean, boolean>;
