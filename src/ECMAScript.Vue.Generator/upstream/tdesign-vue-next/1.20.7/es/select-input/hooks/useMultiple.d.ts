...
export declare function useMultiple(props: TdSelectInputProps, context: SetupContext, popupRef: Ref<PopupInstanceFunctions>): {
    ...
    tagInputRef: Ref<any, any>;
    isMultipleFocus: Ref<boolean, boolean>;
    multipleInputValue: Ref<string, string>;
    renderSelectMultiple: (p: RenderSelectMultipleParams) => import("vue/jsx-runtime").JSX.Element;
};
