...
[ECMAScriptModule]
[WhiteList("System.Text.StringBuilder", WhiteListOp.Allowed, null,"System/Text/StringBuilderModule.js")]
public static class StringBuilderModule
{
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder()", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder(int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder(string)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder(string, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder(string, int, int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.StringBuilder(int, int)", WhiteListOp.Discard)]
	public extern static System.Text.StringBuilder _f69cee28dea8bcdc(Number capacity, Number maxCapacity);

	[WhiteList("System.Text.StringBuilder.Capacity.get", WhiteListOp.Discard)]
	public extern static Number _20274b0eadfc0539(System.Text.StringBuilder instance);

	[WhiteList("System.Text.StringBuilder.Capacity.set", WhiteListOp.Discard)]
	public extern static void _d58ab6215b243f4f(System.Text.StringBuilder instance, Number value);

	[WhiteList("System.Text.StringBuilder.MaxCapacity.get", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.EnsureCapacity(int)", WhiteListOp.Discard)]
	...
	[WhiteList("override System.Text.StringBuilder.ToString()", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.ToString(int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.GetChunks()", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(char, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(char[], int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(string)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(string, int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(System.Text.StringBuilder)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(System.Text.StringBuilder, int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendLine()", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendLine(string)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.CopyTo(int, char[], int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.CopyTo(int, System.Span<char>, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, string, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Remove(int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(bool)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(char)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(sbyte)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(byte)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(short)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(long)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(float)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(double)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(decimal)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(ushort)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(uint)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(ulong)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(System.ReadOnlySpan<char>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(System.ReadOnlyMemory<char>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(ref System.Text.StringBuilder.AppendInterpolatedStringHandler)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Append(System.IFormatProvider, ref System.Text.StringBuilder.AppendInterpolatedStringHandler)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendLine(ref System.Text.StringBuilder.AppendInterpolatedStringHandler)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendLine(System.IFormatProvider, ref System.Text.StringBuilder.AppendInterpolatedStringHandler)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(string, params object[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(string, params System.ReadOnlySpan<object>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin<T>(string, System.Collections.Generic.IEnumerable<T>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(string, params string[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(string, params System.ReadOnlySpan<string>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(char, params object[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(char, params System.ReadOnlySpan<object>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin<T>(char, System.Collections.Generic.IEnumerable<T>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(char, params string[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendJoin(char, params System.ReadOnlySpan<string>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, string)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, bool)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, sbyte)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, byte)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, short)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, char)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, char[], int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, long)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, float)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, double)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, decimal)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, ushort)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, uint)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, ulong)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Insert(int, System.ReadOnlySpan<char>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(string, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(string, object, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(string, object, object, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(string, params object[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(string, params System.ReadOnlySpan<object>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, string, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, string, object, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, string, object, object, object)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, string, params object[])", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, string, params System.ReadOnlySpan<object>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.AppendFormat<TArg0>(System.IFormatProvider, System.Text.CompositeFormat, TArg0)", WhiteListOp.Discard)]
	...
	///<summary>Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.            Each format item is replaced by the string representation of any of the arguments using a specified format provider.</summary>
	[WhiteList("System.Text.StringBuilder.AppendFormat<TArg0, TArg1>(System.IFormatProvider, System.Text.CompositeFormat, TArg0, TArg1)", WhiteListOp.Discard)]
	...
	///<summary>Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.            Each format item is replaced by the string representation of any of the arguments using a specified format provider.</summary>
	[WhiteList("System.Text.StringBuilder.AppendFormat<TArg0, TArg1, TArg2>(System.IFormatProvider, System.Text.CompositeFormat, TArg0, TArg1, TArg2)", WhiteListOp.Discard)]
	...
	///<summary>Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.            Each format item is replaced by the string representation of any of the arguments using a specified format provider.</summary>
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, System.Text.CompositeFormat, params object[])", WhiteListOp.Discard)]
	...
	///<summary>Appends the string returned by processing a composite format string, which contains zero or more format items, to this instance.            Each format item is replaced by the string representation of any of the arguments using a specified format provider.</summary>
	[WhiteList("System.Text.StringBuilder.AppendFormat(System.IFormatProvider, System.Text.CompositeFormat, params System.ReadOnlySpan<object>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(string, string)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(System.ReadOnlySpan<char>, System.ReadOnlySpan<char>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Equals(System.Text.StringBuilder)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Equals(System.ReadOnlySpan<char>)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(string, string, int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(System.ReadOnlySpan<char>, System.ReadOnlySpan<char>, int, int)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(char, char)", WhiteListOp.Discard)]
	...
	[WhiteList("System.Text.StringBuilder.Replace(char, char, int, int)", WhiteListOp.Discard)]
