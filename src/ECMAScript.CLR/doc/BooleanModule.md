...
**成员**：static readonly bool.TrueString</br>
**签名**：_49c57acefc093fcc</br>
**注释**：
...
**成员**：static readonly bool.FalseString</br>
**签名**：_19c3bb431dd19e1f</br>
**注释**：
...
**成员**：bool.Boolean()</br>
**签名**：_2bd9618624257446</br>

**成员**：override bool.GetHashCode()</br>
**签名**：_80b6c29cc0038969</br>
**注释**：
...
**成员**：override bool.ToString()</br>
**签名**：_d48c2d39317daf8f</br>
**注释**：
...
**成员**：bool.ToString(System.IFormatProvider)</br>
**签名**：_6e30cb91da447de8</br>
**注释**：
...
**成员**：bool.TryFormat(System.Span<char>, out int)</br>
**签名**：_811623fcb5eec2f4</br>
**注释**：
...
**成员**：override bool.Equals(object)</br>
**签名**：_97cc6572c33639b7</br>
**注释**：
...
**成员**：bool.Equals(bool)</br>
**签名**：_22566f8453458531</br>
**注释**：
...
**成员**：bool.CompareTo(object)</br>
**签名**：_f877237b160159b0</br>
**注释**：
...
**成员**：bool.CompareTo(bool)</br>
**签名**：_52e94ceda3f9af79</br>
**注释**：
...
**成员**：static bool.Parse(string)</br>
**签名**：_5dbf54319ebc8dfe</br>
**注释**：
...
**成员**：static bool.Parse(System.ReadOnlySpan<char>)</br>
**签名**：_c3ccfdf8f687d2bf</br>
**注释**：
...
**成员**：static bool.TryParse(string, out bool)</br>
**签名**：_dada4bbdacd7aa19</br>
**注释**：
...
**成员**：static bool.TryParse(System.ReadOnlySpan<char>, out bool)</br>
**签名**：_619c4d1c94319558</br>
**注释**：
...
**成员**：bool.GetTypeCode()</br>
**签名**：_eb6a23c2a874fdf1</br>
**注释**：
