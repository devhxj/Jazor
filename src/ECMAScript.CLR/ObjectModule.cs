...
public static class ObjectModule
{
    ...
    [WhiteList("virtual object.Equals(object)", WhiteListOp.Literal, "@#{0} === @#{1}")]
    ...
    [WhiteList("static object.Equals(object, object)", WhiteListOp.Literal, "@#{0} === @#{1}")]
    ...
    [WhiteList("static object.ReferenceEquals(object, object)", WhiteListOp.Literal, "@#{0} === @#{1}")]
