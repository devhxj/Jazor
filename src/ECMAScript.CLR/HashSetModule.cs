...
[ECMAScriptModule]
[WhiteList("System.Collections.Generic.HashSet<T>", WhiteListOp.Allowed, null,"System/Collections/Generic/HashSetModule.js")]
public static class HashSetModule<T>
{
	...
	public extern static HashSet<T>.AlternateLookup<TAlternate> _3ed41a9b4870a040<TAlternate>(Set<T> instance);
	...
	public extern static bool _859aac4462f2d063<TAlternate>(Set<T> instance, Box<object> lookup);
	...
	public extern static HashSet<T>.Enumerator _68a59c6ba9ebe57d(Set<T> instance);
	...
	public extern static bool _20eb460b32c63404(Set<T> instance, object equalValue, Box<object> actualValue);
	...
	public extern static void _b2bd5d22aadd44a8(Set<T> instance, IEnumerable<T> other);
	...
	public extern static void _3a6a072035334578(Set<T> instance, IEnumerable<T> other);
	...
	public extern static void _373e2e9ed1fb3f5b(Set<T> instance, IEnumerable<T> other);
	...
	public extern static void _a22fe44dc0ae9ad2(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _23c8bcfc6b71d2b1(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _fb8566ae66aa9591(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _3be7fbb1d68799fb(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _cc0cc2d0f5be70db(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _84709aa8ff70a52a(Set<T> instance, IEnumerable<T> other);
	...
	public extern static bool _55425d259e5f54ea(Set<T> instance, IEnumerable<T> other);
	...
	public extern static IEqualityComparer<T> _0c0d81e2205a9cb9(Set<T> instance);
	...
	public extern static IEqualityComparer<HashSet<T>> _2d028c1bc3e2f479();
}
