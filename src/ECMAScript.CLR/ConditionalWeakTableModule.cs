...
[ECMAScriptModule]
[WhiteList("System.Runtime.CompilerServices.ConditionalWeakTable<TKey, TValue>", WhiteListOp.Allowed, null,"System/Runtime/CompilerServices/ConditionalWeakTable`2Module.js")]
public static class ConditionalWeakTableModule
{
	...
	public extern static WeakMap<TKey,TValue> _925d15e28de85fd7<TKey, TValue>();
	...
	public extern static bool _8360443cbe5b1f88<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, Box<object> value);

	///<summary>Adds a key to the table.</summary>
	[WhiteList("System.Runtime.CompilerServices.ConditionalWeakTable<TKey, TValue>.Add(TKey, TValue)", WhiteListOp.Discard)]
	public extern static void _c013f77a250570ce<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object value);
	...
	public extern static bool _6a785a77d1b78937<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object value);
	...
	public extern static void _3e5ae776a9edba7b<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object value);
	...
	public extern static bool _0b5841f143b2e9e7<TKey, TValue>(WeakMap<TKey,TValue> instance, object key);

	[WhiteList("System.Runtime.CompilerServices.ConditionalWeakTable<TKey, TValue>.Remove(TKey, out TValue)", WhiteListOp.Discard)]
	public extern static bool _14e40010b1fd2993<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, Box<object> value);
	...
	public extern static void _57912eda7fd377bb<TKey, TValue>(WeakMap<TKey,TValue> instance);

	[WhiteList("System.Runtime.CompilerServices.ConditionalWeakTable<TKey, TValue>.GetOrAdd(TKey, TValue)", WhiteListOp.Discard)]
	public extern static TValue _8e3321f2e6fa2499<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object value);
	...
	public extern static TValue _ed09a626bf4f3ea8<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object valueFactory);
	...
	public extern static TValue _eaeddd47f4a65d81<TKey, TValue, TArg>(WeakMap<TKey,TValue> instance, object key, object valueFactory, object factoryArgument);
	...
	public extern static TValue _43edc29b01c6a1f0<TKey, TValue>(WeakMap<TKey,TValue> instance, object key, object createValueCallback);
	...
	public extern static TValue _8e97651a27c54464<TKey, TValue>(WeakMap<TKey,TValue> instance, object key);
}
