...
internal static class DevtoolsTestCompiler
{
    public static CSharpCompilation CreateCompilation(string code)
    {
        var syntaxTree = CSharpSyntaxTree.ParseText(
            ...
            path: "/src/DevtoolsModule.cs");
        var compilation = CSharpCompilation.Create(
            "ECMAScript.Vue.Devtools.Test.Assembly",
            [syntaxTree],
            ...
            [
                ...
                MetadataReference.CreateFromFile(typeof(VueDevtools).Assembly.Location)
            ]),
