...
internal sealed class JazorDevelopmentFileSnapshotPoller : IAsyncDisposable
{
    ...
    private static IReadOnlyDictionary<string, FileSnapshotEntry> CaptureSnapshot(string rootDirectory)
    {
    ...
    private static IReadOnlyList<string> GetChangedPaths(
    ...
    private readonly record struct FileSnapshotEntry(long Length, long LastWriteTimeUtcTicks);
}
