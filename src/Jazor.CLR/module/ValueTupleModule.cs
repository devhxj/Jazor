...
public static class ValueTupleModule
{
	...
	/// </summary>
	[Jazor(Op.Inline, "override System.ValueTuple.Equals(object)", "(@#{1} === null)")]
	...
	/// JS: [item1]
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1>(T1)", "[@#{0}]")]
	...
	/// JS: [item1, item2]
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2>(T1, T2)", "[@#{0}, @#{1}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3>(T1, T2, T3)", "[@#{0}, @#{1}, @#{2}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3, T4>(T1, T2, T3, T4)", "[@#{0}, @#{1}, @#{2}, @#{3}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3, T4, T5>(T1, T2, T3, T4, T5)", "[@#{0}, @#{1}, @#{2}, @#{3}, @#{4}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6>(T1, T2, T3, T4, T5, T6)", "[@#{0}, @#{1}, @#{2}, @#{3}, @#{4}, @#{5}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6, T7>(T1, T2, T3, T4, T5, T6, T7)", "[@#{0}, @#{1}, @#{2}, @#{3}, @#{4}, @#{5}, @#{6}]")]
	...
	/// </summary>
	[Jazor(Op.Inline, "static System.ValueTuple.Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1, T2, T3, T4, T5, T6, T7, T8)", "[@#{0}, @#{1}, @#{2}, @#{3}, @#{4}, @#{5}, @#{6}, @#{7}]")]
