...
public static class NavigationOptionsModule
{
	...
	// setters and NavigateTo receives exactly the browser options shape.
	[Jazor(Op.Inline, "Microsoft.AspNetCore.Components.NavigationOptions.NavigationOptions()", "({})")]
	...
	public extern static bool RelativeToCurrentUri(Object instance);

	[Jazor(Op.Alias, "Microsoft.AspNetCore.Components.NavigationOptions.RelativeToCurrentUri.init", "relativeToCurrentUri")]
	public extern static void SetRelativeToCurrentUri(Object instance, bool value);
}
