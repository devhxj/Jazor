...
{
	private static BigInt MinValueCore => BigIntFn("-170141183460469231731687303715884105728");
	private static BigInt MaxValueCore => BigIntFn("170141183460469231731687303715884105727");
	private static BigInt Mask => BigIntFn("340282366920938463463374607431768211455");
	private static BigInt Modulus => BigIntFn("340282366920938463463374607431768211456");
	private static BigInt SignBit => BigIntFn("170141183460469231731687303715884105728");
	[Jazor(Op.Discard ,"System.Int128.Int128()")]
	...
	[Jazor(Op.Discard ,"override System.Int128.GetHashCode()")]
	public extern static Number _2de13ea6377940aa(BigInt instance);
	...
	[Jazor(Op.Discard ,"static System.Int128.TryParse(System.ReadOnlySpan<char>, out System.Int128)")]
	public extern static Array<object?> _b0e356aabfe72ec2(string s, BigInt result);
	...
	[Jazor(Op.Discard ,"static System.Int128.TryParse(System.ReadOnlySpan<byte>, out System.Int128)")]
	public extern static Array<object?> _b5211e33c4db2da9(Uint8Array utf8Text, BigInt result);
	...
	///<summary>Adds two values together to compute their sum.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked +(System.Int128, System.Int128)")]
	public extern static BigInt _5e6d45782cb5e4a5(BigInt left, BigInt right);
	...
	[Jazor(Op.Discard ,"static System.Int128.Log10(System.Int128)")]
	public extern static BigInt _f729da8a5282b658(BigInt value);
	...
	[Jazor(Op.Discard ,"static System.Int128.Log2(System.Int128)")]
	public extern static BigInt _f1a059f528650ba2(BigInt value);
	...
	///<summary>Decrements a value.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked --(System.Int128)")]
	public extern static BigInt _1b31f1ebb654733d(BigInt value);
	...
	///<summary>Divides two values together to compute their quotient.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked /(System.Int128, System.Int128)")]
	public extern static BigInt _830753b6d4a84cc4(BigInt left, BigInt right);
	...
	///<summary>Increments a value.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked ++(System.Int128)")]
	public extern static BigInt _6dacb4c587ca3df1(BigInt value);
	...
	///<summary>Multiplies two values together to compute their product.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked *(System.Int128, System.Int128)")]
	public extern static BigInt _056e8fba577b7eeb(BigInt left, BigInt right);

	[Jazor(Op.Discard ,"static System.Int128.BigMul(System.Int128, System.Int128, out System.Int128)")]
	...
	///<summary>Parses a span of characters into a value.</summary>
	[Jazor(Op.Discard ,"static System.Int128.Parse(System.ReadOnlySpan<char>, System.IFormatProvider)")]
	public extern static BigInt _4d90655f04c3cb26(string s, Intl.NumberFormat? provider);

	///<summary>Tries to parse a string into a value.</summary>
	[Jazor(Op.Discard ,"static System.Int128.TryParse(System.ReadOnlySpan<char>, System.IFormatProvider, out System.Int128)")]
	public extern static Array<object?> _18dfb394fe14fa70(string s, Intl.NumberFormat? provider, BigInt result);
	...
	///<summary>Subtracts two values to compute their difference.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked -(System.Int128, System.Int128)")]
	public extern static BigInt _bce2a2f696e0d716(BigInt left, BigInt right);
	...
	///<summary>Computes the unary negation of a value.</summary>
	[Jazor(Op.Discard ,"static System.Int128.operator checked -(System.Int128)")]
	public extern static BigInt _9f88084238b2cecc(BigInt value);
