...
public static class BooleanModule
{
	...
	[Jazor(Op.Compile, "override bool.Equals(object)")]
	...
	[Jazor(Op.Compile, "bool.Equals(bool)")]
	...
	[Jazor(Op.Compile, "bool.CompareTo(object)")]
	...
	[Jazor(Op.Compile, "bool.CompareTo(bool)")]
