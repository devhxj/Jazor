...
public static class CharModule
{
	...
	[Jazor(Op.Discard ,"static char.IsAscii(char)")]
	...
	[Jazor(Op.Discard ,"override char.Equals(object)")]
	...
	[Jazor(Op.Discard ,"char.Equals(char)")]
	...
	[Jazor(Op.Discard ,"char.CompareTo(object)")]
	...
	[Jazor(Op.Discard ,"static char.ToString(char)")]
	...
	[Jazor(Op.Discard ,"static char.Parse(string)")]
	...
	[Jazor(Op.Discard ,"static char.TryParse(string, out char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiLetter(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiLetterLower(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiLetterUpper(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiDigit(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiLetterOrDigit(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiHexDigit(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiHexDigitUpper(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsAsciiHexDigitLower(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsDigit(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsBetween(char, char, char)")]
	...
	[Jazor(Op.Discard ,"static char.IsWhiteSpace(char)")]
	...
	[Jazor(Op.Discard ,"static char.ToUpper(char, System.Globalization.CultureInfo)")]
	...
	[Jazor(Op.Discard ,"static char.ToUpper(char)")]
	...
	[Jazor(Op.Discard ,"static char.ToUpperInvariant(char)")]
	...
	[Jazor(Op.Discard ,"static char.ToLower(char, System.Globalization.CultureInfo)")]
	...
	[Jazor(Op.Discard ,"static char.ToLower(char)")]
	...
	[Jazor(Op.Discard ,"static char.ToLowerInvariant(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsControl(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsControl(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsDigit(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsLower(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsSurrogate(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsSurrogate(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsUpper(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsWhiteSpace(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.GetNumericValue(char)")]
	...
	[Jazor(Op.Discard ,"static char.GetNumericValue(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsHighSurrogate(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsHighSurrogate(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsLowSurrogate(char)")]
	...
	[Jazor(Op.Discard ,"static char.IsLowSurrogate(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsSurrogatePair(string, int)")]
	...
	[Jazor(Op.Discard ,"static char.IsSurrogatePair(char, char)")]
	...
	[Jazor(Op.Discard ,"static char.ConvertFromUtf32(int)")]
	...
	[Jazor(Op.Discard ,"static char.ConvertToUtf32(char, char)")]
	...
	[Jazor(Op.Discard ,"static char.ConvertToUtf32(string, int)")]
