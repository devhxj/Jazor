# ReadOnlySetT1Module.cs

> ⚠️ **注意**：签名= _+ SHA256Hash(成员)

**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.ReadOnlySet(System.Collections.Generic.ISet<T>)</br>
**签名**：_aede400efbd05842</br>
**注释**：
...
**成员**：static System.Collections.ObjectModel.ReadOnlySet<T>.Empty.get</br>
**签名**：_843cd8664672a9f8</br>

**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.Count.get</br>
**签名**：_ede23209845683c4</br>

**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.GetEnumerator()</br>
**签名**：_1d4e088c99161116</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.Contains(T)</br>
**签名**：_a9cd3343f82c8a7b</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.IsProperSubsetOf(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_8745918ab865b9f0</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.IsProperSupersetOf(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_ab53c8c15a545026</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.IsSubsetOf(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_f72f25db872c4c11</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.IsSupersetOf(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_e7d6617cc0e3119e</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.Overlaps(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_520d7f31ddf30fea</br>
**注释**：
...
**成员**：System.Collections.ObjectModel.ReadOnlySet<T>.SetEquals(System.Collections.Generic.IEnumerable<T>)</br>
**签名**：_eb16d835e6822ba0</br>
**注释**：
