    ...
    INamedTypeSymbol? VueLibraryComponentFlagsAttribute)
{
    public static RazorVueCompilationSymbols? TryCreate(Compilation compilation)
    {
        ...
        var jazorComponent = compilation.GetTypeByMetadataName("ECMAScript.Razor.IJazorComponent")
            ?? compilation.GetTypeByMetadataName("Jazor.Razor.IJazorComponent");
        var vueComponent = compilation.GetTypeByMetadataName("Jazor.RazorVue.IVueComponent")
            ?? compilation.GetTypeByMetadataName("ECMAScript.Vue+IVueComponent");
