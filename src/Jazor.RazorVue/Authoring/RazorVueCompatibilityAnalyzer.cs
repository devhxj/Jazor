...
public sealed class RazorVueCompatibilityAnalyzer : DiagnosticAnalyzer
{
    ...
    internal static readonly DiagnosticDescriptor BlazorComponentAdapterUnavailable = new(
        id: "JAZORVCA010",
        title: "Blazor component has no RazorVue browser adapter",
        messageFormat: "Blazor component '{0}' is not yet backed by a RazorVue browser adapter in this profile. Keep the authoring shape standard and use a typed browser component/adapter, rather than adding Vue or RenderTreeBuilder glue.",
        category: "Jazor.RazorVue.Compatibility",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
