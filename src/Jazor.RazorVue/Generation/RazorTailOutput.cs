...
internal static class RazorTailOutput
{
    ...
    private static string BuildVueRenderCatalogSource(ImmutableArray<VueModuleArtifact> artifacts)
    {
        ...
        builder.AppendLine("        {");
        builder.AppendLine("            public GeneratedVueRenderModule(string componentId, string relativePath, string moduleText, string contentHash, string sourceMapRelativePath, string sourceMapContent, string mapHash, string[] packageImports)");
        builder.AppendLine("            {");
