...
/// an implementation detail consumed by an application-owned navigation host.
/// 从 Razor SG 最终符号生成浏览器路由表，页面作者只保留标准 @page/@layout 形状；
/// 路由组件的渲染协议由应用或组件库决定，不在这里伪造 Microsoft 标准组件。
/// </summary>
internal static class RazorVueRouteCatalogBuilder
{
    ...
    private static string BuildModuleText(IReadOnlyList<RouteDefinition> routes)
    {
        ...
        builder.AppendLine("// <auto-generated/> RazorVue route catalog.");
