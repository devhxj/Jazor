...
import { $ as t, D as n, Jt as r, Ot as ee, Pt as i, S as a, X as o, Y as s, i as c, q as l, t as te, vt as ne, w as re, xt as ie, yt as ae } from "./lib-Bttd6u5E.js";
...
import { t as he } from "./Shape-C21CMlWS.js";
import { t as ge } from "./_plugin-vue_export-helper-B3ysoDQm.js";
import { t as _e } from "./DefGrad-DVBqDjhO.js";
import { t as ve } from "./BaseLegendToggle-DZVucLnv.js";
import { t as ye } from "./useUserOptionState-DK-_1ddE.js";
import { t as be } from "./useChartAccessibility-DYqac8yF.js";
import { t as xe } from "./geoProjections-CEo3dVaL.js";
import { Fragment as u, Teleport as Se, computed as d, createBlock as f, createCommentVNode as p, createElementBlock as m, createElementVNode as h, createSlots as Ce, createTextVNode as we, createVNode as g, defineAsyncComponent as _, guardReactiveProps as v, mergeProps as Te, nextTick as Ee, normalizeClass as De, normalizeProps as y, normalizeStyle as b, onBeforeUnmount as Oe, onMounted as ke, openBlock as x, ref as S, renderList as Ae, renderSlot as C, resolveDynamicComponent as je, toDisplayString as w, toRefs as Me, unref as T, watch as E, withCtx as D, withModifiers as Ne } from "vue";
//#region src/resources/worldGeo.js
var Pe = 1e3, Fe = [
	"name",
	"admin",
	"iso_a3",
	"iso_a3_eh"
], Ie = ["Polygon", "MultiPolygon"], Le = [
	[
		[
			"Costa Rica",
			"Costa Rica",
	...
	[
		...
		1,
		[["2586,4zk;4u,4z;mo,-c6;26,-ea;ic,3c;93,bf;6e,-2m;gf,-gs;bn,-il;1m,-ip;-2z,-cn;2p,-9k;21,-gg;9t,-7o;ax,-ok;-j,-9e;-jp,-1v;-qa,kl;-wv,m2;-39,e5;-g3,il;-3u,n0;-a0,f5;31,k9;-64,br"], ["2iyi,36y;-o3,4o;-vx,1;-9n,-vm;-ap,-9o;-e9,-12m;-mn,-5x;-qa,7s;-dc,-2g;-g6,-e2;-hr,20;-hx,-5n;-j0,fp;-4n,ik;kd,-9i;lh,57;5l,ni;bv,59;xb,60;jx,m0;dn,hk;co,-ee;5u,9g;d9,-v;1n,hq;19,dp;le,jb;e0,lq;b9,3;e9,-e2;1a,-c3;ib,-7q;n6,-8d;-1z,-aw;-in,-1d;4y,-dl;-kg,-9g"]]
	],
	[
		[
			"Cyprus",
	...
	[
		...
		1,
		[["2sws,wks;0,0;0,0;0,0"], ["2ssw,wpn;0,0;3w,-4v;-ak,1o;-c2,-9f;-8b,-9g;12,-jy;-ed,-65;-4y,-4x;-ah,-87;-ii,-4l;-c2,-7g;-v,-c1;-39,-33;b2,-4i;fr,-c7;-40,-6q;-bu,-1t;-jn,-1d;-at,-cj;-cf,z;-1q,-2i;-di,5a;-3d,-58;-85,-2b;-z,58;-77,2k;-7h,4f;7m,c8;6k,3a;-2h,53;72,ez;-1u,4j;-g8,31;-d3,7g;mm,hu;um,ex;j3,jq;d7,-8q;o0,-10;-4c,en;16x,bz;b1,fk;hy,-ge"]]
	],
	[
		[
			"Bhutan",
	...
	[
		...
		1,
		[["16lk,his;q,b7;84,bi;3,bd;ck,5h;-4x,3v;2a,i3;e7,4;cg,-iz;fi,-a3;ke,-3n;gg,-52;ck,-fy;7h,-98;9y,-3i;-2,-67;-a4,-gk;-4g,-7t;-bp,-8w;-ad,-j1;-cm,1g;-5s,-6m;-4g,-e3;3f,-ik;-2n,-3f;-cs,3;-hc,-ae;-2q,-dj;-6c,-5v;-hb,8;-av,-70;5,-b8;-dg,-7p;-fc,2m;-ik,-9d;-cu,-1l;-93,jf;-lq,19u;2bc,rs;ij,1jk;-cr,jo"], ["17et,jub;-5a,9g;83,9h;3g,-2f;-2n,-bh;-3m,-51"]]
	],
	[
		[
			"Uzbekistan",
	...
	[
		...
		1,
		[["zt1,wat;7t,-y;j3,-gv;cb,-1x;4r,73;gl,b7;em,-en;e5,-jp;cy,-1b;8k,-7h;-mw,-29;-4u,-ll;-4s,-9q;-a6,-6i;q,-dr;-6x,-1e;-hb,ek;9l,dr;-88,85;-af,-22;-wr,-kh;-n,j9;-cg,4k;-bt,7k;7u,8u;-et,9k;5l,6y;-al,4t;-5r,7b;6t,4j;kq,-7z;ez,-1o;3s,3a;-dp,f1;78,3u"], ["zls,tw5;-j2,3p;-e1,cu;-4f,ah;5s,r;88,-7g;ca,2;-5,-4a;bd,-g3"]]
	],
	[
		[
			"Turkey",
	...
	[
		...
		1,
		[["7nm,16fb;-hs,-48;-l0,3o;-ba,ff;-u,se;4n,7i;7y,8c;oh,1q;9s,7o;mc,7u;-y,-ea;-88,-92;3c,-7s;f2,-47;-6s,-ai;-8a,31;-k0,-k0;7k,-dj"], ["9jn,17an;8v,-dx;-go,-mi;-t2,fp;-3w,bj;14r,97"]]
	],
	[
		[
			"Romania",
	...
	[
		...
		1,
		[["-4s6,15kc;-l0,5q;-h6,-e;5q,ew;-5q,ew;na,15;ts,-h6;-ew,-j3"], ["-2dy,157h;2,-1;43,g5;-im,h4;-f,e;-xq,4w;-6n,7j;a4,ce;-95,7o;-ey,-d5;-1n,qs;-e1,e6;a3,sq;ll,mj;m7,-27;xi,2c;-tp,-u2;sb,3t;ug,-5;-79,-mn;-oz,-ow;sq,-1s;27,-2x;or,-ws;j1,-4h;h3,-vn;7x,-az;xo,-5a;-3e,-hs;-e5,-85;b3,-ee;-p0,-ej;-116,9;-1ba,-7n;-cy,5h;-id,-d1;-pq,36;-ji,-am;-es,5k;14r,t6;ov,60;-8,1;-17d,4m;-7v,b2;t1,8m;-f8,ez;5a,i7;15a,-2i"]]
	],
	[
		[
			"Greece",
		...
		1,
		[["kaa,r8k;-3h,-87;-140,-2d;a,4l;-xw,5f;55,bt;f7,-9d;lm,1l;ko,-1z;-o,-4u;f5,3c"], ["hpk,vwa;kk,-t;m9,7n;jk,-9q;p9,2n;b,du;dj,-7d;-8l,-he;-6m,-34;-gx,t;-ei,2m;-xn,-78;j9,-fm;-e4,-4j;-fh,-1;-ep,eb;-58,-63;68,-gm;dw,-d1;-ah,-63;fh,-ct;dr,-82;f,-fp;-pp,7d;87,-e6;-hn,-2x;aj,-oi;-ig,-d;-ms,c3;-af,m8;-4v,ih;-au,cs;-e8,fu;-1w,7x;cx,dh;1o,91;91,41;k,7b;i6,2g;al,63;f2,-k;4l,4v;5a,x"]]
	],
	[
		[
			"Austria",
	...
	[
		...
		1,
		[["3shi,-uwy;-ai,-ez;-ds,-j1;-lg,-b2;-4s,7a;-bl,40;g1,mv;-94,fa;-tw,b4;s,a2;k3,9p;4o,le;-1a,hz;-b9,im;r,4w;-da,bh;-lv,ol;-bm,jo;ab,26;f4,-ff;lm,-77;7v,-or;k5,-t9;l,iz;cj,-7l;45,-l0;md,-92;is,-28;fv,al;e3,-37;-6q,-oo;-8h,-g7;-l7,k;-7f,-8g;2l,-by;-43,-56"], ["3mx0,-xlv;nt,ej;go,ef;cd,kq;aj,71;44,fi;ji,cu;65,-bt;6b,-bh;jr,b9;82,-bq;1,-bp;-ad,-cv;-i5,-kh;-e8,-b6;a9,-dd;-lf,-d;-ns,-ah;-7g,-i6;-fs,-s4;-lu,-cf;-dv,-7x;-pl,l;-hz,96;-u7,1y;-4o,a7;ex,km;yy,rf;hx,58;jz,al"]]
	],
	[
		[
			"New Caledonia",
	...
	[
		...
		1,
		[["3l0x,-c9g;hg,-fy;-96,-3o;-9b,c6;11,7g"], ["3kp5,-c39;-3z,7o;-l,lb;db,-8k;4i,-me;-7h,3h;-5s,-1i"]]
	],
	[
		[
			"Antarctica",
...
function Re(e) {
	let t = {};
	for (let n = 0; n < Fe.length; n += 1) e[n] != null && (t[Fe[n]] = e[n]);
	return t;
}
function ze(e) {
	let t = 0, n = 0;
	return e ? e.split(";").map((e) => {
		let r = e.indexOf(",");
		return t += parseInt(e.slice(0, r), 36), n += parseInt(e.slice(r + 1), 36), [t / Pe, n / Pe];
	}) : [];
}
function Be(e, t) {
	return e ? t.map((e) => e.map(ze)) : t.map(ze);
}
var Ve = {
	type: "FeatureCollection",
	features: Le.map(([e, t, n]) => ({
		type: "Feature",
		properties: Re(e),
		geometry: {
			type: Ie[t],
...
}, He = /* @__PURE__ */ e({ default: () => st }), Ue = ["id"], We = ["id"], Ge = ["viewBox", "xmlns"], Ke = [
	"x",
	"y",
	"width",
	"height"
], qe = { key: 1 }, Je = ["id"], Ye = { key: 0 }, Xe = [
	"cx",
	"cy",
	"r",
	"fill"
...
}, rt = ["id"], it = ["onClick"], at = ["innerHTML"], ot = .5, st = /*#__PURE__*/ ge({
	__name: "vue-ui-world",
	props: {
		config: {
			type: Object,
	...
	setup(e, { expose: ge, emit: Pe }) {
		let Fe = _(() => import("./Title-BE3qg9xl.js").then((e) => e.t)), Ie = _(() => import("./Legend-CQxUgOd-.js").then((e) => e.n)), Le = _(() => import("./Tooltip-DhjyfHwz.js")), Re = _(() => import("./BaseIcon-BfndwIWE.js").then((e) => e.n)), ze = _(() => import("./vue-ui-accordion-DegI2lzR.js").then((e) => e.n)), Be = _(() => import("./DataTable-BbKgJ5UI.js")), He = _(() => import("./PenAndPaper-DAE-tnEQ.js").then((e) => e.t)), st = _(() => import("./UserOptions-Dt98of5H.js").then((e) => e.n)), ct = _(() => import("./PackageVersion-CtRPcMPr.js").then((e) => e.t)), lt = _(() => import("./BaseDraggableDialog-LoqqwRtV.js").then((e) => e.n)), { vue_ui_world: ut } = ce(), O = e, dt = Pe, ft = d({
			get() {
				return !!I.value;
			},
			set(e) {
		...
		}), pt = d(() => ft ? Object.values(I.value).some((e) => Object.hasOwn(e, "category")) : !1), k = S(null), mt = S(null), ht = S(null), gt = S(null), _t = S(null), vt = S(0), yt = S(0), bt = S(0), A = S(l()), j = S(!1), xt = S(""), St = S(0), Ct = S(!1), M = S(null), wt = S(null);
		ke(() => {
			Ct.value = !0;
		});
		let N = Ve, { projections: Tt, getProjectedBounds: Et, setupTerritories: Dt, geoToPath: Ot } = xe;
		function kt() {
			let e = fe({
				userConfig: O.config,
				defaultConfig: ut
			});
			return O.config && ne(O.config, "style.chart.territory.colors.min") ? e.style.chart.territory.colors.min = a(O.config.style.chart.territory.colors.min) : e.style.chart.territory.colors.min = e.style.chart.territory.emptyColor, O.config && ne(O.config, "style.chart.territory.colors.max") ? e.style.chart.territory.colors.max = a(O.config.style.chart.territory.colors.max) : e.style.chart.territory.colors.max = i[0], N = Dt(e, N), e;
		}
		let P = S(kt());
		oe({
			config: () => P.value,
		...
		let F = d(() => P.value.userOptions.useCursorPointer), At = d(() => r({
			defaultConfig: {
				userOptions: { show: !1 },
				table: { show: !1 },
				style: { chart: {
					backgroundColor: "#99999930",
					globe: { waterColor: "#8A8A8A" },
					territory: {
						stroke: "#6A6A6A",
						colors: {
							min: "#E0E0E0",
		...
		}), { userOptionsVisible: Mt, setUserOptionsVisibility: Nt, keepUserOptionState: Pt } = ye({ config: P.value }), { svgRef: L } = be({ config: P.value.style.chart.title }), R = S({
			showTable: P.value.table.show,
			showTooltip: P.value.style.chart.tooltip.show
		});
		E(() => O.config, (e) => {
			P.value = kt(), Mt.value = !P.value.userOptions.showOnChartHover, vt.value += 1, bt.value += 1, yt.value += 1, R.value.showTable = P.value.table.show, R.value.showTooltip = P.value.style.chart.tooltip.show;
		}), E(P, () => {
			R.value = {
				showTable: P.value.table.show,
				showTooltip: P.value.style.chart.tooltip.show
		...
		let Ft = d(() => re(P.value.customPalette)), z = d(() => P.value.projection || "globe"), B = d(() => {
			let { height: e, width: t } = P.value.style.chart.dimensions;
			return {
				aitoff: {
					width: t || 1e3,
					height: e || 500
			...
			let { minX: e, minY: t, width: n, height: r } = Et(Tt[z.value], N.features, B.value.width, B.value.height, q.value);
			return {
				str: `${e} ${t} ${n} ${r}`,
				minX: e,
				minY: t,
		...
		}), It = d(() => Object.values(I.value).map((e) => e.value)), Lt = d(() => Math.min(...It.value)), Rt = d(() => Math.max(...It.value));
		function zt(e) {
			return typeof e == "number" ? ae(P.value.style.chart.territory.colors.min || "#FFFFFF00", P.value.style.chart.territory.colors.max || Ft.value[0] || i[0], Lt.value, Rt.value, e) : P.value.style.chart.territory.emptyColor;
		}
		function Bt(e) {
			return Ot(e, {
				projection: z.value,
		...
		let Vt = d(() => {
			let e = Object.values(I.value).filter((e) => !!e.category), t = {};
			return e.forEach((e) => {
				t[e.category] || (t[e.category] = e);
			}), Object.values(t).map((e, t) => ({
				name: e.category,
				color: e.color ? a(e.color) : Ft.value[t] || i[t] || i[t % i.length]
			}));
		});
		function Ht(e) {
			let t = Vt.value.find((t) => t.name === e);
			return t ? t.color : "#000000";
		}
		let Ut = /* @__PURE__ */ new Map();
		function Wt(e) {
			return Ut.has(e) || Ut.set(e, `territory-${l()}`), Ut.get(e);
		}
		let H = d(() => (q.value, N.features.map((e) => {
			let t = e.properties.iso_a3;
			(!t || t === "-99") && (t = e.properties.iso_a3_eh);
			let n = I.value[t];
			return {
				path: Bt(e.geometry),
				...
				code: t,
				geometry: e.geometry,
				color: n && n.color ? a(n.color) : n && n.category ? Ht(n.category) : zt(n ? n.value : null),
		...
		let Yt = d(() => P.value.userOptions.show && !P.value.style.chart.title.text), { isPrinting: Xt, isImaging: Zt, generatePdf: Qt, generateImage: $t } = le({
			elementId: `world_${A.value}`,
			fileName: P.value.style.chart.title.text || "vue-ui-world",
			options: P.value.userOptions.print
		}), G = S(!1), en = S(null), K = S(null), tn = d(() => K.value ? Bt(K.value.geometry) : "");
		function nn(e) {
			return e ? e.type === "Polygon" ? e.coordinates : e.type === "MultiPolygon" ? e.coordinates.reduce((e, t) => t[0].length > (e[0]?.length || 0) ? t : e, []) : [] : [];
		}
		let rn = d(() => {
			let e = K.value?.geometry;
			if (!e) return "";
			let t = nn(e);
			if (!t.length) return "";
			let n = t.flat(), r = [n.reduce((e, [t]) => e + t, 0) / n.length, n.reduce((e, [, t]) => e + t, 0) / n.length], ee = Tt[z.value] || Tt.globe, i = B.value.width, a = B.value.height, o = t.map((e) => e.map(([e, t]) => ee([e, t], i, a, r))), s = o.flat(), c = s.map(([e, t]) => e), l = s.map(([e, t]) => t), te = Math.min(...c), ne = Math.max(...c), re = Math.min(...l), ie = Math.max(...l), ae = ne - te || 1, oe = ie - re || 1, se = Math.min(64 / ae, 64 / oe);
			function ce([e, t]) {
				return [(e - te) * se + 8, (t - re) * se + 8];
			}
			return `
        <svg width="80" height="80" viewBox="0 0 80 80" style="display:block;margin:auto;">
        <rect x="0" y="0" width="80" height="80" rx="12" fill="transparent" opacity="0.93"/>
        <path d="${o.map((e) => "M" + e.map(ce).map(([e, t]) => `${e},${t}`).join("L") + "Z").join(" ")}" fill="${K.value?.color || P.value.style.chart.territory.emptyColor}" stroke="${P.value.style.chart.territory.stroke}" stroke-width="1"/>
        </svg>
    `;
		});
		function an({ datapoint: e, seriesIndex: t }) {
			j.value = !1, K.value = null, P.value.events.datapointLeave && P.value.events.datapointLeave({
				datapoint: e,
				seriesIndex: t
			});
		}
		function on({ datapoint: e, seriesIndex: t }) {
			dt("selectDatapoint", e), P.value.events.datapointClick && P.value.events.datapointClick({
				datapoint: e,
				seriesIndex: t
			});
		}
		function sn({ datapoint: e, seriesIndex: t }) {
			...
			let n = "", r = P.value.style.chart.tooltip.customFormat;
			if (G.value = !1, ie(r)) try {
				let t = r({
					datapoint: e,
					config: P.value,
					series: H.value
				});
				typeof t == "string" && (xt.value = t, G.value = !0);
			} catch {
				console.warn("Custom format cannot be applied."), G.value = !1;
			}
			G.value || (n += `
        <div style="width:100%;">
            ${P.value.style.chart.tooltip.showMinimap ? `<div class="vue-ui-world-minimap">${rn.value}</div>` : ""}
            <div style="display:flex;flex-direction:row;flex-wrap:nowrap;align-items:center;justify-content:center;gap:4px">
                <svg viewBox="0 0 20 20" height="14" width="14">
                    <circle cx="10" cy="10" r="10" fill="${e.color}"/>
                </svg>
                <span>${e.name}:</span>
                <b>
                    ${c(P.value.style.chart.dataLabels.formatter, e.value, o({
				p: P.value.style.chart.dataLabels.prefix,
				v: e.value,
				s: P.value.style.chart.dataLabels.suffix,
				r: P.value.style.chart.dataLabels.rounding
			}))}    
                </b>
            </div>
        </div>
		...
		let cn = S(!1), ln = S({
			x: 0,
			y: 0
		}), q = S([P.value.style.chart.globe.center.x, P.value.style.chart.globe.center.y]), un = [0, 0], J = null, Y = null;
		function dn(e) {
		...
		function mn(e) {
			if (J = e, typeof requestAnimationFrame > "u") {
				pn();
				return;
			}
		...
		E(() => [P.value.style.chart.globe.center.x, P.value.style.chart.globe.center.y], ([e, t]) => {
			q.value = [e, t], J = null;
		});
		function hn(e, t) {
			cn.value = !0, ln.value = {
				x: e,
				y: t
			}, un = J || [q.value[0], q.value[1]];
		}
		function gn(e, t) {
			if (!cn.value || z.value !== "globe" || W.value) return;
			let n = e - ln.value.x, r = t - ln.value.y;
			mn([fn(un[0] - n * ot), dn(un[1] + r * ot)]);
		}
		function _n() {
			cn.value = !1, Y !== null && typeof cancelAnimationFrame < "u" && (cancelAnimationFrame(Y), Y = null), pn();
		}
		function vn(e) {
			hn(e.clientX, e.clientY);
		}
		function yn(e) {
			gn(e.clientX, e.clientY);
		}
		function bn() {
			_n();
		}
		function xn(e) {
			let t = e.touches[0];
			hn(t.clientX, t.clientY);
		}
		function Sn(e) {
			let t = e.touches[0];
			gn(t.clientX, t.clientY);
		}
		function Cn() {
			_n();
		}
		Oe(() => {
			Y !== null && typeof cancelAnimationFrame < "u" && (cancelAnimationFrame(Y), Y = null);
		});
		let X = d(() => {
			let e = H.value.toSorted((e, t) => (t.value || 0) - (e.value || 0));
			return {
				head: e.map((e) => ({
					name: e.name,
					color: e.color,
		...
		function Tn(e = null) {
			Ee(() => {
				let r = X.value.head.map((e, t) => [[e.name], [X.value.body[t]]]), ee = [
				...
				e ? e(i) : t({
					csvContent: i,
					title: P.value.style.chart.title.text || "vue-ui-world"
				});
			});
		}
		let Z = S([]);
		function En() {
			Z.value.length ? Z.value = [] : Q.value.forEach((e) => {
				Z.value.push(e.name);
			});
		}
		function Dn(e) {
			Z.value.includes(e) ? Z.value = Z.value.filter((t) => t !== e) : Z.value.push(e), dt("selectLegend", { name: e });
		}
		let Q = d(() => pt ? Vt.value.map(({ name: e, color: t }, n) => ({
			name: e,
			color: t,
			shape: "circle",
			patternIndex: n
			...
			...e,
			opacity: Z.value.includes(e.name) ? .5 : 1,
			segregate: () => Dn(e.name),
			isSegregated: Z.value.includes(e.name)
		})) : []), On = d(() => ({
			cy: "donut-div-legend",
		...
		async function An({ scale: e = 2 } = {}) {
			if (!k.value) return;
			let { width: t, height: n } = k.value.getBoundingClientRect(), r = t / n, { imageUri: ee, base64: i } = await me({
				domElement: k.value,
				base64: !0,
				img: !0,
				scale: e
		...
		E(() => R.value.showTable, (e) => {
			P.value.table.show || (e && P.value.table.useDialog && M.value ? M.value.open() : "close" in M.value && M.value.close());
		});
		function jn() {
			R.value.showTable = !1, wt.value && wt.value.setTableIconState(!1);
		}
		let Mn = d(() => P.value.style.chart.backgroundColor), Nn = d(() => P.value.style.chart.legend), Pn = d(() => P.value.style.chart.title), { isCallbackImaging: Fn, isCallbackSvg: In, generateSvg: Ln, onGenerateImage: Rn } = pe({
			svg: L,
			title: Pn,
			legend: Nn,
			legendItems: Q,
		...
		return ge({
			...
			ref: k,
			id: `world_${A.value}`,
			class: De(`vue-data-ui-component vue-ui-world ${U.value ? "vue-data-ui-wrapper-fullscreen" : ""}`),
			style: b(`font-family:${P.value.style.fontFamily};width:100%; text-align:center;background:${P.value.style.chart.backgroundColor}`),
			onMouseenter: t[2] ||= () => T(Nt)(!0),
			onMouseleave: t[3] ||= () => T(Nt)(!1)
		}, [
			P.value.userOptions.buttons.annotator && T(L) ? (x(), f(T(He), {
				key: 0,
				color: P.value.style.chart.color,
				backgroundColor: P.value.style.chart.backgroundColor,
				active: W.value,
			...
			P.value.style.chart.title.text ? (x(), m("div", {
				key: 2,
				ref_key: "chartTitle",
				ref: mt,
			...
			P.value.userOptions.show && ft.value && (T(Pt) || T(Mt)) ? (x(), f(T(st), {
				...
				hasTooltip: P.value.style.chart.tooltip.show && P.value.userOptions.buttons.tooltip,
				...
				onGeneratePdf: T(Qt),
				onGenerateCsv: Tn,
				onGenerateImage: T(Rn),
				onGenerateSvg: T(Ln),
				onToggleTable: qt,
				onToggleTooltip: Jt,
				onToggleAnnotator: Kt,
				onCopyAlt: zn,
				style: b({ visibility: T(Pt) ? T(Mt) ? "visible" : "hidden" : "visible" })
			}, Ce({ _: 2 }, [
				e.$slots.menuIcon ? {
					name: "menuIcon",
				...
				e.$slots.optionTooltip ? {
					name: "optionTooltip",
					fn: D(() => [C(e.$slots, "optionTooltip", {}, void 0, !0)]),
					key: "1"
				} : void 0,
				e.$slots.optionPdf ? {
					name: "optionPdf",
			...
			]), 1032, /* @__PURE__ */ "backgroundColor.color.isPrinting.isImaging.uid.callbacks.hasTooltip.hasPdf.hasImg.hasSvg.hasXls.hasTable.hasFullscreen.hasAltCopy.isFullscreen.chartElement.position.printScale.isTooltip.titles.hasAnnotator.isAnnotation.tableDialog.isCursorPointer.onGeneratePdf.onGenerateImage.onGenerateSvg.style".split("."))) : p("", !0),
			(x(), m("svg", {
				ref_key: "svgRef",
				ref: L,
				viewBox: V.value.str,
				...
				class: De({
					...
					"vue-data-ui-fullscreen--off": !U.value
				}),
				style: b({
					maxWidth: "100%",
					overflow: z.value === "globe" ? "visible" : "hidden",
					background: "transparent",
					color: P.value.style.chart.color,
					paddingTop: P.value.style.chart.padding.top + "px",
					paddingRight: P.value.style.chart.padding.right + "px",
					paddingBottom: P.value.style.chart.padding.bottom + "px",
					paddingLeft: P.value.style.chart.padding.left + "px"
				}),
				onMousedown: vn,
				onMousemove: yn,
				onMouseup: bn,
				...
				}, [C(e.$slots, "chart-background", {}, void 0, !0)], 8, Ke)) : p("", !0),
				ft.value ? (x(), m("g", qe, [
					z.value === "globe" ? (x(), m(u, { key: 0 }, [
						h("defs", null, [
							g(_e, {
								t: "radial",
								id: `water-${A.value}`,
								...
								stops: [
									[
										"0%",
										T(ee)(P.value.style.chart.globe.waterColor, .4),
										1
									],
									[
										"45%",
										P.value.style.chart.globe.waterColor,
										1
									],
									[
										"80%",
										T(s)(P.value.style.chart.globe.waterColor, .2),
										1
									],
									[
										"100%",
										T(s)(P.value.style.chart.globe.waterColor, .5),
										.95
									]
								]
							}, null, 8, ["id", "stops"]),
							...
							h("filter", {
								...
								width: "160%",
								height: "160%"
							}, [...t[4] ||= [h("feGaussianBlur", { stdDeviation: "8" }, null, -1)]], 8, Je)
						]),
						e.$slots.pattern ? (x(), m("g", Ye, [(x(!0), m(u, null, Ae(H.value, (t, n) => (x(), m("defs", null, [C(e.$slots, "pattern", Te({ ref_for: !0 }, {
							...t,
							patternId: `pattern_${A.value}_${t.code}`
						}), void 0, !0)]))), 256))])) : p("", !0),
						h("circle", {
							cx: V.value.width / 2 + 20,
							cy: V.value.height / 2 + 20,
							r: V.value.height / 2,
							fill: `url(#water-${A.value})`
						}, null, 8, Xe),
						h("circle", {
							cx: V.value.width / 2 + 20,
							cy: V.value.height / 2 + 20,
							r: V.value.height / 2 + 10,
							fill: `url(#atmo-realistic-${A.value})`,
							"pointer-events": "none",
							filter: `url(#blur-${A.value})`
						}, null, 8, Ze)
					], 64)) : p("", !0),
					(x(!0), m(u, null, Ae(H.value, (t, n) => (x(), m(u, { key: t.code }, [h("path", {
						d: t.path,
						fill: t.category && Z.value.includes(t.category) ? P.value.style.chart.territory.emptyColor : t.color,
						stroke: P.value.style.chart.territory.stroke,
						"stroke-width": K.value && K.value.uid === t.uid ? P.value.style.chart.territory.strokeWidthSelected : P.value.style.chart.territory.strokeWidth,
						onMouseenter: (e) => sn({
							datapoint: t,
							seriesIndex: n
						}),
					...
					}, [!j.value || !R.value.showTooltip ? (x(), m("title", $e, [we(w(t.name) + " ", 1), typeof t.value == "number" ? (x(), m(u, { key: 0 }, [we(" : " + w(t.value), 1)], 64)) : p("", !0)])) : p("", !0)], 40, Qe), e.$slots.pattern ? (x(), m("path", {
						key: 0,
						d: t.path,
						fill: `url(#pattern_${A.value}_${t.code})`,
						stroke: P.value.style.chart.territory.stroke,
						"stroke-width": P.value.style.chart.territory.strokeWidthSelected,
						style: { "pointer-events": "none" },
						class: "vue-ui-world-territory"
					}, null, 8, et)) : p("", !0)], 64))), 128)),
					K.value ? (x(), m("path", {
						key: 1,
						d: tn.value,
						fill: "transparent",
				...
				C(e.$slots, "svg", { svg: {
					height: B.value.height,
					width: B.value.width,
					isPrintingImg: T(Xt) || T(Zt) || T(Fn),
					isPrintingSvg: T(In)
				} }, void 0, !0)
			], 46, Ge)),
			e.$slots.watermark ? (x(), m("div", nt, [C(e.$slots, "watermark", y(v({ isPrinting: T(Xt) || T(Zt) || T(Fn) || T(In) })), void 0, !0)])) : p("", !0),
			h("div", { id: `legend-bottom-${A.value}` }, null, 8, rt),
			Ct.value && pt.value && (P.value.style.chart.legend.show || e.$slots.legend) ? (x(), f(Se, {
				key: 5,
				to: P.value.style.chart.legend.position === "top" ? `#legend-top-${A.value}` : `#legend-bottom-${A.value}`
			}, [pt.value ? (x(), m("div", {
				key: 0,
				ref_key: "chartLegend",
				ref: ht
			}, [C(e.$slots, "legend", { legend: Q.value }, () => [P.value.style.chart.legend.show ? (x(), f(T(Ie), {
				key: `legend_${yt.value}`,
				legendSet: Q.value,
				config: On.value,
				isCursorPointer: F.value,
				onClickMarker: t[0] ||= (e) => Dn(e)
			}, Ce({
				item: D(({ legend: e, index: t }) => [h("div", {
					style: b(`opacity:${Z.value.includes(e.name) ? .5 : 1}`),
					onClick: (t) => e.segregate()
				}, w(e.name), 13, it)]),
				legendToggle: D(() => [Q.value.length > 2 && P.value.style.chart.legend.selectAllToggle.show && !T(jt) ? (x(), f(ve, {
					key: 0,
					backgroundColor: P.value.style.chart.legend.selectAllToggle.backgroundColor,
					color: P.value.style.chart.legend.selectAllToggle.color,
					fontSize: P.value.style.chart.legend.fontSize,
					checked: Z.value.length > 0,
					isCursorPointer: F.value,
					onToggle: En
				}, null, 8, [
					"backgroundColor",
			...
			g(T(Le), {
				...
				show: R.value.showTooltip && j.value,
				...
				"tooltip-before": D(() => [C(e.$slots, "tooltip-before", y(v({ ...en.value })), void 0, !0)]),
				tooltip: D(() => [C(e.$slots, "tooltip", y(v({ ...en.value })), void 0, !0)]),
				"tooltip-after": D(() => [C(e.$slots, "tooltip-after", y(v({ ...en.value })), void 0, !0)]),
				_: 3
			}, 8, [
				"teleportTo",
				"show",
			...
			ft.value && P.value.userOptions.buttons.table ? (x(), f(je($.value.component), Te({ key: 7 }, $.value.props, {
				ref_key: "tableUnit",
				ref: M,
				onClose: jn
			}), Ce({
				content: D(() => [(x(), f(T(Be), {
					...
					td: D(({ td: e }) => [we(w(e.name ? e.name : e.category ? e.category : T(c)(P.value.style.chart.dataLabels.formatter, e, T(o)({
						p: P.value.style.chart.dataLabels.prefix,
						v: e,
						s: P.value.style.chart.dataLabels.suffix,
						r: P.value.style.chart.dataLabels.rounding
				...
				fn: D(() => [h("button", {
					...
					onClick: t[1] ||= (e) => Tn(P.value.userOptions.callbacks.csv),
			...
			C(e.$slots, "skeleton", {}, () => [T(jt) ? (x(), f(de, { key: 0 })) : p("", !0)], !0)
		], 46, Ue));
	}
}, [["__scopeId", "data-v-fb4a5885"]]);
//#endregion
