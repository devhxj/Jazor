...
{
    private const string FileChangeDebounceIntervalEnvironmentVariable = "JOLT_DEVSERVER_FILE_CHANGE_DEBOUNCE_MS";
    private const string FileChangePollingIntervalEnvironmentVariable = "JOLT_DEVSERVER_FILE_CHANGE_POLLING_MS";
