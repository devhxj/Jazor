...
internal static class JazorImportDirectiveLocator
{
        ...
        out bool endsComment)
    {
        ...
        var trailing = lineContent[(index + terminator.Length)..];
...
internal enum JazorImportDirectiveKind
{
    Module,
    Import,
    JsImport,
...
internal readonly struct JazorImportDirectiveMatch
{
