...
internal sealed class RazorSdkToolsetResolver
{
    ...
    internal static RazorTasksTargetFrameworkSortKey GetTargetFrameworkSortKey(string path)
    {
...
internal readonly record struct RazorTasksTargetFrameworkSortKey(int FamilyRank, Version Version) : IComparable<RazorTasksTargetFrameworkSortKey>
{
