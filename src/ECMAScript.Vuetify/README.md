...
- 为 `VBtn`、`VTextField`、`VTextarea`、`VCheckbox`、`VSwitch`、`VSelect`、`VAutocomplete`、`VCombobox`、`VFileInput`、`VNumberInput`、`VSlider`、`VDataTable`、`VImg`、`VProgressLinear` 等高频组件提供专用强类型 props；其余组件先提供 `AdditionalAttributes` 透传桩。
