...
/// </summary>
[ECMAScript("vuetify/labs/components/VStepperVertical", Transform.Component, "VStepperVertical")]
public sealed class VStepperVertical : ComponentBase, IVuetifyComponent
{
    /// <summary>
    /// 垂直步骤条当前选中的步骤值。
