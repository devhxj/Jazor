...
[VueSlot(nameof(Top), Name = "top")]
[VueSlot(nameof(Colgroup), Name = "colgroup")]
[VueSlot(nameof(HeadersContent), Name = "headers")]
[VueSlot(nameof(HeaderSelect), Name = "header.data-table-select")]
[VueSlot(nameof(HeaderExpand), Name = "header.data-table-expand")]
[VueSlot(nameof(BodyContent), Name = "body")]
...
[VueSlot(nameof(GroupHeader), Name = "group-header")]
[VueSlot(nameof(ExpandedRow), Name = "expanded-row")]
[VueSlot(nameof(Tbody), Name = "tbody")]
[VueSlot(nameof(Thead), Name = "thead")]
[VueSlot(nameof(Tfoot), Name = "tfoot")]
[VueSlot(nameof(Bottom), Name = "bottom")]
[VueSlot(nameof(FooterPrepend), Name = "footer.prepend")]
[VueSlot(nameof(LoadingContent), Name = "loading")]
