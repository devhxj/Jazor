...
internal static class Program
{
    ...
    private static readonly Dictionary<string, Type> RuntimeTypeMap = new(StringComparer.Ordinal)
    {
        ...
        ["ElementPlusSelectV2ModelValue"] = typeof(ElementPlusSelectV2ModelValue),
        ["ElementPlusPopperPlacement"] = typeof(ElementPlusPopperPlacement)
    };
    ...
    private static readonly Dictionary<(string TagName, string RuntimeName), ExplicitGeneratedType> ExplicitPropTypeOverrides = new()
    {
        ...
        [("el-calendar", "controllerType")] = ExplicitGeneratedType.Value("ElementPlusCalendarControllerType"),
        [("el-card", "shadow")] = ExplicitGeneratedType.Value("ElementPlusCardShadow"),
        [("el-affix", "position")] = ExplicitGeneratedType.Value("ElementPlusTopBottomPlacement"),
        ...
        [("el-avatar", "shape")] = ExplicitGeneratedType.Value("ElementPlusAvatarShape"),
        [("el-avatar-group", "shape")] = ExplicitGeneratedType.Value("ElementPlusAvatarShape"),
        [("el-avatar-group", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-avatar-group", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        [("el-button", "type")] = ExplicitGeneratedType.Value("ElementPlusButtonType"),
        [("el-button", "nativeType")] = ExplicitGeneratedType.Value("ElementPlusButtonNativeType"),
        [("el-button-group", "type")] = ExplicitGeneratedType.Value("ElementPlusButtonType"),
        [("el-button-group", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-collapse", "modelValue")] = ExplicitGeneratedType.Value("VueStringNumberArrayableValue"),
        [("el-collapse", "expandIconPosition")] = ExplicitGeneratedType.Value("ElementPlusCollapseIconPosition"),
        ...
        [("el-dropdown", "type")] = ExplicitGeneratedType.Value("ElementPlusButtonType"),
        [("el-dropdown", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        [("el-dropdown", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-dropdown", "buttonProps")] = ExplicitGeneratedType.Reference("ElementPlusButtonProps"),
        [("el-carousel", "trigger")] = ExplicitGeneratedType.Value("ElementPlusHoverClickTrigger"),
        [("el-carousel", "type")] = ExplicitGeneratedType.Value("ElementPlusCarouselType"),
        [("el-carousel", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-container", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-descriptions", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-image", "fit")] = ExplicitGeneratedType.Value("ElementPlusImageFitType"),
        [("el-image", "loading")] = ExplicitGeneratedType.Value("ElementPlusImageLoadingType"),
        [("el-image", "crossorigin")] = ExplicitGeneratedType.Value("ElementPlusCrossorigin"),
        ...
        [("el-form", "rules")] = ExplicitGeneratedType.Reference("ElementPlusFormRules"),
        [("el-form-item", "prop")] = ExplicitGeneratedType.Value("VueStringOrStringsValue"),
        [("el-form-item", "rules")] = ExplicitGeneratedType.Value("ElementPlusFormItemRules"),
        [("el-form-item", "validateStatus")] = ExplicitGeneratedType.Value("ElementPlusFormItemValidateStatus"),
        ...
        [("el-divider", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-divider", "contentPosition")] = ExplicitGeneratedType.Value("ElementPlusContentPosition"),
        ...
        [("el-menu", "menuTrigger")] = ExplicitGeneratedType.Value("ElementPlusHoverClickTrigger"),
        ...
        [("el-popover", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-popover", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        ...
        [("el-select", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-select", "tagType")] = ExplicitGeneratedType.Value("ElementPlusTagType"),
        [("el-select", "tagEffect")] = ExplicitGeneratedType.Value("ElementPlusTagEffect"),
        [("el-select", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        ...
        [("el-progress", "type")] = ExplicitGeneratedType.Value("ElementPlusProgressType"),
        [("el-progress", "status")] = ExplicitGeneratedType.Value("ElementPlusProgressStatus"),
        [("el-segmented", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-space", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-step", "status")] = ExplicitGeneratedType.Value("ElementPlusStepStatus"),
        [("el-steps", "direction")] = ExplicitGeneratedType.Value("ElementPlusDirection"),
        [("el-steps", "finishStatus")] = ExplicitGeneratedType.Value("ElementPlusStepStatus"),
        [("el-steps", "processStatus")] = ExplicitGeneratedType.Value("ElementPlusStepStatus"),
        [("el-text", "type")] = ExplicitGeneratedType.Value("ElementPlusSemanticType"),
        [("el-timeline", "mode")] = ExplicitGeneratedType.Value("ElementPlusTimelineMode"),
        [("el-timeline-item", "placement")] = ExplicitGeneratedType.Value("ElementPlusTopBottomPlacement"),
        [("el-timeline-item", "type")] = ExplicitGeneratedType.Value("ElementPlusSemanticType"),
        [("el-rate", "colors")] = ExplicitGeneratedType.Value("ElementPlusRateColorsValue"),
        [("el-rate", "icons")] = ExplicitGeneratedType.Value("ElementPlusRateIconsValue"),
        ...
        [("el-slider", "marks")] = ExplicitGeneratedType.Reference("ElementPlusSliderMarks"),
        ...
        [("el-tooltip", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        [("el-tabs", "type")] = ExplicitGeneratedType.Value("ElementPlusTabsType"),
        [("el-tabs", "tabPosition")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacementSide"),
        [("el-tag", "type")] = ExplicitGeneratedType.Value("ElementPlusTagType"),
        [("el-tag", "effect")] = ExplicitGeneratedType.Value("ElementPlusTagEffect"),
        ...
        [("el-transfer", "renderContent")] = ExplicitGeneratedType.Reference("ElementPlusTransferRenderContent"),
        ...
        [("el-tree-select", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-tree-select", "tagType")] = ExplicitGeneratedType.Value("ElementPlusTagType"),
        [("el-tree-select", "tagEffect")] = ExplicitGeneratedType.Value("ElementPlusTagEffect"),
        [("el-tree-select", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        ...
        [("el-upload", "crossorigin")] = ExplicitGeneratedType.Value("ElementPlusCrossorigin"),
        [("el-upload", "fileList")] = ExplicitGeneratedType.Reference("ElementPlusUploadUserFile[]"),
        [("el-upload", "listType")] = ExplicitGeneratedType.Value("ElementPlusUploadListType"),
        ...
        [("el-table-v2", "headerClass")] = ExplicitGeneratedType.Value("ElementPlusTableV2ClassValue"),
        [("el-table-v2", "headerProps")] = ExplicitGeneratedType.Value("ElementPlusTableV2DynamicPropsValue"),
        [("el-table-v2", "headerCellProps")] = ExplicitGeneratedType.Value("ElementPlusTableV2DynamicPropsValue"),
        [("el-table-v2", "headerHeight")] = ExplicitGeneratedType.Value("ElementPlusTableV2HeaderHeightValue"),
        [("el-table-v2", "rowClass")] = ExplicitGeneratedType.Value("ElementPlusTableV2ClassValue"),
        [("el-table-v2", "rowKey")] = ExplicitGeneratedType.Value("ElementPlusTableV2KeyValue"),
        [("el-table-v2", "rowProps")] = ExplicitGeneratedType.Value("ElementPlusTableV2DynamicPropsValue"),
        [("el-table-v2", "rowEventHandlers")] = ExplicitGeneratedType.Reference("ElementPlusTableV2RowEventHandlers"),
        [("el-table-v2", "cellProps")] = ExplicitGeneratedType.Value("ElementPlusTableV2DynamicPropsValue"),
        [("el-table-v2", "columns")] = ExplicitGeneratedType.Reference("ElementPlusTableV2Column[]"),
        [("el-table-v2", "data")] = ExplicitGeneratedType.Reference("ElementPlusTableV2DataItem[]"),
        [("el-table-v2", "dataGetter")] = ExplicitGeneratedType.Reference("ElementPlusTableV2DataGetter"),
        [("el-table-v2", "fixedData")] = ExplicitGeneratedType.Reference("ElementPlusTableV2DataItem[]"),
        [("el-table-v2", "expandedRowKeys")] = ExplicitGeneratedType.Reference("ElementPlusTableV2KeyValue[]"),
        [("el-table-v2", "defaultExpandedRowKeys")] = ExplicitGeneratedType.Reference("ElementPlusTableV2KeyValue[]"),
        [("el-table-v2", "sortBy")] = ExplicitGeneratedType.Reference("ElementPlusTableV2SortBy"),
        [("el-table-v2", "sortState")] = ExplicitGeneratedType.Reference("ElementPlusTableV2SortState"),
        [("el-virtualized-select", "modelValue")] = ExplicitGeneratedType.Value("ElementPlusSelectV2ModelValue"),
        [("el-virtualized-select", "options")] = ExplicitGeneratedType.Reference("ElementPlusSelectV2OptionValue[]"),
        ...
        [("el-virtualized-select", "effect")] = ExplicitGeneratedType.Value("ElementPlusPopperEffect"),
        [("el-virtualized-select", "placement")] = ExplicitGeneratedType.Value("ElementPlusPopperPlacement"),
        [("el-virtualized-select", "fallbackPlacements")] = ExplicitGeneratedType.Reference("string[]"),
        [("el-virtualized-select", "tagType")] = ExplicitGeneratedType.Value("ElementPlusTagType"),
        [("el-virtualized-select", "tagEffect")] = ExplicitGeneratedType.Value("ElementPlusTagEffect"),
