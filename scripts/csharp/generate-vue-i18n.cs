...
// Validate the locked vue-i18n ESM entry and regenerate package metadata and upstream inventory.
// Runtime modules remain in the restored npm package; this binding owns the C# contract and
// metadata only.
// 上游以 npm registry integrity 锁定版本；vue-i18n 的 bundle 引用 Intlify 核心包，以及由 ECMAScript.Vue
// 资源库提供的 vue peer 与 Vue devtools API。
//
// Usage:
//   dotnet run --file scripts/csharp/generate-vue-i18n.cs -- --version 11.4.12
//   dotnet run --file scripts/csharp/generate-vue-i18n.cs -- --source .tmp/p3b/node_modules --version 11.4.12
...
const string libraryId = "vue-i18n";
const string primaryPackage = "vue-i18n";
const string documentation = "https://vue-i18n.intlify.dev/";
const string licenseId = "MIT";

var projectRoot = Path.Combine(root, "src", "ECMAScript.VueI18n");
...
// vue-i18n 需要 @vue/devtools-api（vue3 资源库已提供 @vue/devtools-api 入口）。
