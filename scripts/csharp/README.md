...
- `verify-compiler-coverage.cs` runs the complete compiler suite and fails unless at least 10,000 tests pass with 98% line and 94% branch coverage for `Jazor.Compiler`.
